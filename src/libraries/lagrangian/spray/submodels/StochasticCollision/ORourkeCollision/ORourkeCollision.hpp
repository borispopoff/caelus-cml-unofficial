...
#ifndef ORourkeCollision_HPP
#define ORourkeCollision_HPP
...
template<class CloudType>
void CML::ORourkeCollision<CloudType>::collide
(
    typename CloudType::parcelType::trackingData& td,
    const scalar dt
)
...
template<class CloudType>
bool CML::ORourkeCollision<CloudType>::collideParcels
(
    const scalar dt,
    parcelType& p1,
    parcelType& p2,
...
template<class CloudType>
bool CML::ORourkeCollision<CloudType>::collideSorted
(
    const scalar dt,
    parcelType& p1,
    parcelType& p2,
...
template<class CloudType>
CML::ORourkeCollision<CloudType>::ORourkeCollision
(
    const dictionary& dict,
    CloudType& owner,
