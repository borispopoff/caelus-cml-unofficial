...
CML::InflationInjection<CloudType>::InflationInjection
(
    const CML::InflationInjection<CloudType>& im
)
:
...
template<class CloudType>
CML::label CML::InflationInjection<CloudType>::parcelsToInject
(
    const scalar time0,
    const scalar time1
)
...
template<class CloudType>
CML::scalar CML::InflationInjection<CloudType>::volumeToInject
(
    const scalar time0,
    const scalar time1
)
...
template<class CloudType>
void CML::InflationInjection<CloudType>::setPositionAndCell
(
    const label parcelI,
    const label,
    const scalar,
...
template<class CloudType>
void CML::InflationInjection<CloudType>::setProperties
(
    const label parcelI,
    const label,
    const scalar,
...
template<class CloudType>
bool CML::InflationInjection<CloudType>::fullyDescribed() const
{
    return false;
}
...
template<class CloudType>
bool CML::InflationInjection<CloudType>::validInjection(const label)
{
    return true;
}
