...
Class
    CML::ReactingMultiphaseLookupTableInjection
...
#include "reactingMultiphaseParcelInjectionDataIOList.hpp"
...
template<class CloudType>
CML::ReactingMultiphaseLookupTableInjection<CloudType>::
ReactingMultiphaseLookupTableInjection
(
    const dictionary& dict,
    CloudType& owner,
...
template<class CloudType>
CML::scalar
CML::ReactingMultiphaseLookupTableInjection<CloudType>::timeEnd() const
{
...
template<class CloudType>
CML::label
CML::ReactingMultiphaseLookupTableInjection<CloudType>::parcelsToInject
(
    const scalar time0,
    const scalar time1
)
...
template<class CloudType>
CML::scalar
CML::ReactingMultiphaseLookupTableInjection<CloudType>::volumeToInject
(
    const scalar time0,
    const scalar time1
)
...
template<class CloudType>
void CML::ReactingMultiphaseLookupTableInjection<CloudType>::setPositionAndCell
(
    const label parcelI,
    const label nParcels,
    const scalar time,
...
template<class CloudType>
void CML::ReactingMultiphaseLookupTableInjection<CloudType>::setProperties
(
    const label parcelI,
    const label nParcels,
    const scalar,
...
template<class CloudType>
bool
CML::ReactingMultiphaseLookupTableInjection<CloudType>::fullyDescribed() const
{
    return true;
}
...
template<class CloudType>
bool CML::ReactingMultiphaseLookupTableInjection<CloudType>::validInjection
(
    const label
)
{
