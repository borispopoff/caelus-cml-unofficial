...
#ifndef COxidationHurtMitchell_HPP
#define COxidationHurtMitchell_HPP
...
template<class CloudType>
CML::COxidationHurtMitchell<CloudType>::COxidationHurtMitchell
(
    const dictionary& dict,
    CloudType& owner
)
...
) const
{
    ...
    const scalar qCs = min(convSI*Rk*CML::sqrt(ppO2/101325.0), qCsLim);
