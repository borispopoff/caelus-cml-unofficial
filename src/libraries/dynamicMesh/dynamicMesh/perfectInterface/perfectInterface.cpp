...
const CML::scalar CML::perfectInterface::tol_ = 1E-3;


// * * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * //

CML::pointField CML::perfectInterface::calcFaceCentres
(
...
CML::perfectInterface::perfectInterface
(
    const word& name,
    const label index,
...
bool CML::perfectInterface::changeTopology() const
{
...
void CML::perfectInterface::setRefinement
(
...
void CML::perfectInterface::setRefinement(polyTopoChange& ref) const
{
    if (debug)
    {
...
void CML::perfectInterface::modifyMotionPoints(pointField& motionPoints) const
{
...
void CML::perfectInterface::updateMesh(const mapPolyMesh& morphMap)
{
...
void CML::perfectInterface::write(Ostream& os) const
{
    os  << nl << type() << nl
        << name()<< nl
        << faceZoneID_.name() << nl
...
void CML::perfectInterface::writeDict(Ostream& os) const
{
