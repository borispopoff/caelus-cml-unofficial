...
void CML::attachDetach::clearAddressing() const
{
...
bool CML::attachDetach::setAttach() const
{
    if (!attached())
    {
        trigger_ = true;
...
bool CML::attachDetach::setDetach() const
{
    if (attached())
    {
        trigger_ = true;
...
bool CML::attachDetach::changeTopology() const
{
    if (manualTrigger())
    {
        if (debug)
...
void CML::attachDetach::setRefinement(polyTopoChange& ref) const
{
...
void CML::attachDetach::updateMesh(const mapPolyMesh&)
{
...
void CML::attachDetach::write(Ostream& os) const
{
    os  << nl << type() << nl
        << name()<< nl
        << faceZoneID_.name() << nl
...
void CML::attachDetach::writeDict(Ostream& os) const
{
