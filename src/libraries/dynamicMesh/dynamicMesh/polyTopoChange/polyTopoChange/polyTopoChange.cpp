...
void CML::polyTopoChange::renumberReverseMap
(
    const labelList& map,
...
void CML::polyTopoChange::renumber
(
    const labelList& map,
    labelHashSet& elems
)
...
void CML::polyTopoChange::renumberCompact
(
    const labelList& map,
    labelList& elems
)
...
void CML::polyTopoChange::countMap
(
    const labelList& map,
...
CML::labelHashSet CML::polyTopoChange::getSetIndices
(
...
void CML::polyTopoChange::writeMeshStats(const polyMesh& mesh, Ostream& os)
{
...
void CML::polyTopoChange::getMergeSets
(
...
bool CML::polyTopoChange::hasValidPoints(const face& f) const
{
    forAll(f, fp)
    {
...
CML::pointField CML::polyTopoChange::facePoints(const face& f) const
{
...
void CML::polyTopoChange::makeCells
(
...
// of faces
void CML::polyTopoChange::makeCellCells
(
    const label nActiveFaces,
...
CML::label CML::polyTopoChange::getCellOrder
(
...
void CML::polyTopoChange::getFaceOrder
(
    const label nActiveFaces,
...
void CML::polyTopoChange::reorderCompactFaces
(
    const label newSize,
...
void CML::polyTopoChange::compact
(
...
CML::labelList CML::polyTopoChange::selectFaces
(
...
void CML::polyTopoChange::calcFaceInflationMaps
(
    const polyMesh& mesh,
...
void CML::polyTopoChange::calcCellInflationMaps
(
    const polyMesh& mesh,
...
void CML::polyTopoChange::resetZones
(
    const polyMesh& mesh,
    polyMesh& newMesh,
...
CML::face CML::polyTopoChange::rotateFace
(
    const face& f,
    const label nPos
)
...
void CML::polyTopoChange::reorderCoupledFaces
(
...
void CML::polyTopoChange::compactAndReorder
(
    const polyMesh& mesh,
    const bool syncParallel,
    const bool orderCells,
...
CML::polyTopoChange::polyTopoChange(const label nPatches, const bool strict)
:
    strict_(strict),
    nPatches_(nPatches),
    points_(0),
...
// Construct from components
CML::polyTopoChange::polyTopoChange
(
    const polyMesh& mesh,
    const bool strict
)
...
void CML::polyTopoChange::addMesh
(
    const polyMesh& mesh,
...
void CML::polyTopoChange::setCapacity
(
    const label nPoints,
    const label nFaces,
    const label nCells
...
CML::label CML::polyTopoChange::setAction(const topoAction& action)
{
...
CML::label CML::polyTopoChange::addPoint
(
    const point& pt,
...
void CML::polyTopoChange::movePoints(const pointField& newPoints)
{
...
CML::label CML::polyTopoChange::addFace
(
    const face& f,
    const label own,
    const label nei,
...
CML::label CML::polyTopoChange::addCell
(
    const label masterPointID,
    const label masterEdgeID,
    const label masterFaceID,
...
CML::autoPtr<CML::mapPolyMesh> CML::polyTopoChange::changeMesh
(
    polyMesh& mesh,
    const bool inflate,
    const bool syncParallel,
...
CML::autoPtr<CML::mapPolyMesh> CML::polyTopoChange::makeMesh
(
