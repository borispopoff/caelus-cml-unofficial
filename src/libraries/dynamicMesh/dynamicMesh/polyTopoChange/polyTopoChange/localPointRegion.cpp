...
bool CML::localPointRegion::isDuplicate
(
    const face& f0,
    const face& f1,
    const bool forward
...
void CML::localPointRegion::countPointRegions
(
    const polyMesh& mesh,
...
void CML::localPointRegion::calcPointRegions
(
    const polyMesh& mesh,
...
CML::localPointRegion::localPointRegion(const polyMesh& mesh)
:
    //nRegions_(0),
    meshPointMap_(0),
    pointRegions_(0),
...
CML::localPointRegion::localPointRegion
(
    const polyMesh& mesh,
...
CML::labelList CML::localPointRegion::findDuplicateFaces
(
...
CML::List<CML::labelPair> CML::localPointRegion::findDuplicateFacePairs
(
    const polyMesh& mesh
)
{
...
void CML::localPointRegion::updateMesh(const mapPolyMesh& map)
{
    {
