...
CML::label CML::removeFaces::changeFaceRegion
(
...
// - removal of edges
// - removal of points
CML::boolList CML::removeFaces::getFacesAffected
(
    const labelList& cellRegion,
...
void CML::removeFaces::mergeFaces
(
    const labelList& cellRegion,
    const labelList& cellRegionMaster,
    const labelHashSet& pointsToRemove,
...
CML::label CML::removeFaces::compatibleRemoves
(
    const labelList& facesToRemove,
    labelList& cellRegion,
...
void CML::removeFaces::setRefinement
(
    const labelList& faceLabels,
    const labelList& cellRegion,
    const labelList& cellRegionMaster,
