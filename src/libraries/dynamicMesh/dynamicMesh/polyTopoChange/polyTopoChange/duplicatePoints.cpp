...
// Construct from mesh
CML::duplicatePoints::duplicatePoints(const polyMesh& mesh)
:
    mesh_(mesh),
    duplicates_(0)
{}
...
void CML::duplicatePoints::setRefinement
(
...
void CML::duplicatePoints::updateMesh(const mapPolyMesh& map)
{
