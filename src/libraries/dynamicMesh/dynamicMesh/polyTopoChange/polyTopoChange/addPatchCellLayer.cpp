...
CML::label CML::addPatchCellLayer::nbrFace
(
...
// dealt with already)
bool CML::addPatchCellLayer::sameEdgeNeighbour
(
...
CML::labelPair CML::addPatchCellLayer::getEdgeString
(
    const indirectPrimitivePatch& pp,
    const labelListList& globalEdgeFaces,
    const boolList& doneEdge,
...
CML::label CML::addPatchCellLayer::addSideFace
(
    const indirectPrimitivePatch& pp,
...
CML::label CML::addPatchCellLayer::findProcPatch
(
    const polyMesh& mesh,
...
// Construct from mesh
CML::addPatchCellLayer::addPatchCellLayer
(
    const polyMesh& mesh,
...
CML::labelListList CML::addPatchCellLayer::addedCells
(
    const polyMesh& mesh,
...
CML::labelListList CML::addPatchCellLayer::addedCells() const
{
...
CML::labelListList CML::addPatchCellLayer::globalEdgeFaces
(
    const polyMesh& mesh,
...
void CML::addPatchCellLayer::calcSidePatch
(
    const polyMesh& mesh,
    const globalIndex& globalFaces,
    const labelListList& globalEdgeFaces,
...
void CML::addPatchCellLayer::setRefinement
(
    const globalIndex& globalFaces,
    const labelListList& globalEdgeFaces,
...
void CML::addPatchCellLayer::updateMesh
(
