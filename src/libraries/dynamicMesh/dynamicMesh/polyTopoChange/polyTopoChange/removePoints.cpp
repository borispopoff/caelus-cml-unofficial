...
CML::label CML::removePoints::countPointUsage
(
    const scalar minCos,
...
void CML::removePoints::setRefinement
(
...
void CML::removePoints::updateMesh(const mapPolyMesh& map)
{
    if (undoable_)
    {
...
void CML::removePoints::getUnrefimentSet
(
...
) const
{
...

    {
        ...
        (
            ...
            CML::dummyTransform()      // no transformation
        );
...
void CML::removePoints::setUnrefinement
(
