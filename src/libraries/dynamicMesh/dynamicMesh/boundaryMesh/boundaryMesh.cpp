...
#include "uindirectPrimitivePatch.hpp"
...
void CML::boundaryMesh::markEdges
(
...
CML::label CML::boundaryMesh::findPatchID
(
...
CML::wordList CML::boundaryMesh::patchNames() const
{
...
CML::labelList CML::boundaryMesh::faceToEdge
(
...
CML::labelList CML::boundaryMesh::edgeToFace
(
    const label region,
...
void CML::boundaryMesh::clearOut()
{
    if (meshPtr_)
    {
        delete meshPtr_;
...
void CML::boundaryMesh::read(const polyMesh& mesh)
{
    patches_.clear();
...
void CML::boundaryMesh::readTriSurface(const fileName& fName)
{
    ...
    label caelusRegion = regionToBoundaryPatch[surfRegion];

    Pout<< "Surface region " << surfRegion << " becomes boundary patch "
        << caelusRegion << " with name " << patches_[caelusRegion].name() << endl;
...
void CML::boundaryMesh::writeTriSurface(const fileName& fName) const
{
...
CML::labelList CML::boundaryMesh::getNearest
(
...
void CML::boundaryMesh::patchify
(
...
void CML::boundaryMesh::setFeatureEdges(const scalar minCos)
{
...
void CML::boundaryMesh::setExtraEdges(const label edgeI)
{
...
void CML::boundaryMesh::addPatch(const word& patchName)
{
...
void CML::boundaryMesh::deletePatch(const word& patchName)
{
...
void CML::boundaryMesh::changePatchType
(
    const word& patchName,
...
void CML::boundaryMesh::changeFaces
(
