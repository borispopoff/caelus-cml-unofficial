...
bool CML::fvMeshSubset::checkCellSubset() const
{
...
void CML::fvMeshSubset::markPoints
(
...
void CML::fvMeshSubset::doCoupledPatches
(
    const bool syncPar,
...
labelList CML::fvMeshSubset::subset
(
    const label nElems,
...
void CML::fvMeshSubset::subsetZones()
{
...
CML::labelList CML::fvMeshSubset::getCellsToRemove
(
...
void CML::fvMeshSubset::setCellSubset
(
...
void CML::fvMeshSubset::setLargeCellSubset
(
    const labelList& region,
    const label currentRegion,
    const label patchID,
...
CML::labelList CML::fvMeshSubset::getExposedFaces
(
    const labelList& region,
    const label currentRegion,
...
const fvMesh& CML::fvMeshSubset::subMesh() const
{
    checkCellSubset();
...
fvMesh& CML::fvMeshSubset::subMesh()
{
    checkCellSubset();
...
const labelList& CML::fvMeshSubset::pointMap() const
{
    checkCellSubset();
...
const labelList& CML::fvMeshSubset::faceMap() const
{
    checkCellSubset();
...
const labelList& CML::fvMeshSubset::cellMap() const
{
    checkCellSubset();
...
const labelList& CML::fvMeshSubset::patchMap() const
{
    checkCellSubset();
