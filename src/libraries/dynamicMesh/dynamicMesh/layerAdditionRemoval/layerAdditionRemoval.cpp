...
const CML::scalar CML::layerAdditionRemoval::addDelta_ = 0.3;
const CML::scalar CML::layerAdditionRemoval::removeDelta_ = 0.1;
...
CML::scalar CML::layerAdditionRemoval::readOldThickness
(
...
void CML::layerAdditionRemoval::clearAddressing() const
{
    // Layer removal data
...
bool CML::layerAdditionRemoval::changeTopology() const
{
...
void CML::layerAdditionRemoval::setRefinement(polyTopoChange& ref) const
{
...
void CML::layerAdditionRemoval::updateMesh(const mapPolyMesh&)
{
    if (debug)
    {
...
void CML::layerAdditionRemoval::write(Ostream& os) const
{
    os  << nl << type() << nl
        << name()<< nl
        << faceZoneID_ << nl
...
void CML::layerAdditionRemoval::writeDict(Ostream& os) const
{
