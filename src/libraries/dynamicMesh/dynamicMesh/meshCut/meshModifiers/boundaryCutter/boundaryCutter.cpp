...
CML::boundaryCutter::boundaryCutter(const polyMesh& mesh)
:
    mesh_(mesh),
    edgeAddedPoints_(),
    faceAddedPoint_()
...
CML::boundaryCutter::~boundaryCutter()
{}
...
void CML::boundaryCutter::updateMesh(const mapPolyMesh& morphMap)
{
