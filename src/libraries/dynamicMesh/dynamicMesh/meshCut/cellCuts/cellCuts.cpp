...
CML::label CML::cellCuts::findPartIndex
(
...
CML::boolList CML::cellCuts::expand
(
    const label size,
...
CML::scalarField CML::cellCuts::expand
(
    const label size,
    const labelList& labels,
...
CML::label CML::cellCuts::firstUnique
(
    const labelList& lst,
    const Map<label>& map
)
...
CML::labelList CML::cellCuts::nonAnchorPoints
(
...
CML::pointField CML::cellCuts::loopPoints
(
    const labelList& loop,
...
CML::scalarField CML::cellCuts::loopWeights(const labelList& loop) const
{
...
bool CML::cellCuts::validEdgeLoop
(
    const labelList& loop,
    const scalarField& loopWeights
) const
...
void CML::cellCuts::setFromCellLoops()
{
...
void CML::cellCuts::setFromCellCutter
(
...
void CML::cellCuts::calcLoopsAndAddressing(const labelList& cutCells)
{
...
void CML::cellCuts::writeOBJ(Ostream& os) const
{
    label vertI = 0;
