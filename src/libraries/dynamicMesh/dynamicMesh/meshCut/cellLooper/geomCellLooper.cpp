...
// edge endpoints
const CML::scalar CML::geomCellLooper::pointEqualTol_ = 1E-3;


// Snap cuts through edges onto edge endpoints. Fraction of edge length.
CML::scalar CML::geomCellLooper::snapTol_ = 0.1;
...
CML::scalar CML::geomCellLooper::minEdgeLen(const label vertI) const
{
    scalar minLen = GREAT;
...
bool CML::geomCellLooper::cutEdge
(
...
CML::label CML::geomCellLooper::snapToVert
(
    const scalar tol,
    const label edgeI,
    const scalar weight
...
void CML::geomCellLooper::getBase(const vector& n, vector& e0, vector& e1)
 const
{
...
// the edge end points.
bool CML::geomCellLooper::edgeEndsCut
(
...
CML::geomCellLooper::geomCellLooper(const polyMesh& mesh)
:
    cellLooper(mesh)
{}
...
CML::geomCellLooper::~geomCellLooper()
{}
