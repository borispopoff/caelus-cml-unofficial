...
void CML::hexCellLooper::makeFace
(
...
CML::hexCellLooper::hexCellLooper(const polyMesh& mesh)
:
    geomCellLooper(mesh),
...
CML::hexCellLooper::~hexCellLooper()
{}


// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //

bool CML::hexCellLooper::cut
(
    const vector& refDir,
    const label celli,
