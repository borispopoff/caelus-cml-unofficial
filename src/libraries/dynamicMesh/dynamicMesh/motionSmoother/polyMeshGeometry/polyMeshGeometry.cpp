...
void CML::polyMeshGeometry::updateFaceCentresAndAreas
(
    const pointField& p,
...
void CML::polyMeshGeometry::updateCellCentresAndVols
(
...
CML::labelList CML::polyMeshGeometry::affectedCells
(
    const polyMesh& mesh,
    const labelList& changedFaces
)
...
CML::scalar CML::polyMeshGeometry::checkNonOrtho
(
    const polyMesh& mesh,
    const bool report,
...
CML::scalar CML::polyMeshGeometry::calcSkewness
(
    const point& ownCc,
    const point& neiCc,
    const point& fc
...
bool CML::polyMeshGeometry::checkFaceTet
(
    const polyMesh& mesh,
    const bool report,
...
CML::polyMeshGeometry::polyMeshGeometry(const polyMesh& mesh)
:
    mesh_(mesh)
{
    correct();
...
void CML::polyMeshGeometry::correct()
{
...
bool CML::polyMeshGeometry::checkFaceDotProduct
(
    const bool report,
...
bool CML::polyMeshGeometry::checkFacePyramids
(
    const bool report,
...
bool CML::polyMeshGeometry::checkFaceTets
(
    const bool report,
    const scalar minTetQuality,
    const polyMesh& mesh,
...
bool CML::polyMeshGeometry::checkFaceSkewness
(
    const bool report,
...
bool CML::polyMeshGeometry::checkFaceWeights
(
    const bool report,
...
bool CML::polyMeshGeometry::checkVolRatio
(
    const bool report,
...
bool CML::polyMeshGeometry::checkFaceAngles
(
    const bool report,
    const scalar maxDeg,
    const polyMesh& mesh,
...
bool CML::polyMeshGeometry::checkFaceTwist
(
    const bool report,
...
bool CML::polyMeshGeometry::checkTriangleTwist
(
    const bool report,
    const scalar minTwist,
    const polyMesh& mesh,
...
bool CML::polyMeshGeometry::checkFaceArea
(
    const bool report,
...
bool CML::polyMeshGeometry::checkCellDeterminant
(
    const bool report,
