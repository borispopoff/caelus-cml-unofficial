...
void CML::motionSmoother::testSyncPositions
(
...
//CML::tmp<CML::scalarField> CML::motionSmoother::sumWeights
//(
...
void CML::motionSmoother::makePatchPatchAddressing()
{
    if (debug)
    {
...
CML::labelHashSet CML::motionSmoother::getPoints
(
...
void CML::motionSmoother::minSmooth
(
...
void CML::motionSmoother::scaleField
(
...
void CML::motionSmoother::getAffectedFacesAndPoints
(
...
CML::motionSmoother::motionSmoother
(
    polyMesh& mesh,
    pointMesh& pMesh,
...
const CML::polyMesh& CML::motionSmoother::mesh() const
{
    return mesh_;
}


const CML::pointMesh& CML::motionSmoother::pMesh() const
{
    return pMesh_;
}


const CML::indirectPrimitivePatch& CML::motionSmoother::patch() const
{
    return pp_;
}


const CML::labelList& CML::motionSmoother::adaptPatchIDs() const
{
    return adaptPatchIDs_;
}


const CML::dictionary& CML::motionSmoother::paramDict() const
{
    return paramDict_;
}


CML::pointVectorField& CML::motionSmoother::displacement()
{
    return displacement_;
}


const CML::pointVectorField& CML::motionSmoother::displacement() const
{
    return displacement_;
}


const CML::pointScalarField& CML::motionSmoother::scale() const
{
    return scale_;
}


const CML::pointField& CML::motionSmoother::oldPoints() const
{
    return oldPoints_;
}


void CML::motionSmoother::correct()
{
    oldPoints_ = mesh_.points();
...
void CML::motionSmoother::setDisplacement(pointField& patchDisp)
{
...
void CML::motionSmoother::correctBoundaryConditions
(
...
CML::tmp<CML::scalarField> CML::motionSmoother::movePoints
(
...
CML::scalar CML::motionSmoother::setErrorReduction
(
...
bool CML::motionSmoother::scaleMesh
(
...
void CML::motionSmoother::updateMesh()
{
...
template<>
void CML::motionSmoother::applyCornerConstraints<CML::scalar>
(
