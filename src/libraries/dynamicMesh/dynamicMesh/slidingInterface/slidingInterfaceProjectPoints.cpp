...
const CML::scalar CML::slidingInterface::pointMergeTolDefault_ = 0.05;
const CML::scalar CML::slidingInterface::edgeMergeTolDefault_ = 0.01;
const CML::label CML::slidingInterface::nFacesPerSlaveEdgeDefault_ = 5;
const CML::label CML::slidingInterface::edgeFaceEscapeLimitDefault_ = 10;

const CML::scalar CML::slidingInterface::integralAdjTolDefault_ = 0.05;
const CML::scalar
    CML::slidingInterface::edgeMasterCatchFractionDefault_ = 0.4;
const CML::scalar CML::slidingInterface::edgeEndCutoffTolDefault_ = 0.0001;
...
bool CML::slidingInterface::projectPoints() const
{
    if (debug)
    {
...
//     Pout<< "slavePointEdgeHits: " << slavePointEdgeHits << endl;
    ...
    // Please change consistently with coupleSlidingInterface.cpp
    //
...
void CML::slidingInterface::clearPointProjection() const
{
    deleteDemandDrivenData(slavePointPointHitsPtr_);
    deleteDemandDrivenData(slavePointEdgeHitsPtr_);
    deleteDemandDrivenData(slavePointFaceHitsPtr_);
