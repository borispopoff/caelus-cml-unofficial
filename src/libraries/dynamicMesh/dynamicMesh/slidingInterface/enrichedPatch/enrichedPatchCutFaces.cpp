...
const CML::label CML::enrichedPatch::maxFaceSizeDebug_ = 100;
...
void CML::enrichedPatch::calcCutFaces() const
{
...
void CML::enrichedPatch::clearCutFaces()
{
...
const CML::faceList& CML::enrichedPatch::cutFaces() const
{
    if (!cutFacesPtr_)
    {
        calcCutFaces();
...
const CML::labelList& CML::enrichedPatch::cutFaceMaster() const
{
...
const CML::labelList& CML::enrichedPatch::cutFaceSlave() const
{
    if (!cutFaceSlavePtr_)
    {
        calcCutFaces();
