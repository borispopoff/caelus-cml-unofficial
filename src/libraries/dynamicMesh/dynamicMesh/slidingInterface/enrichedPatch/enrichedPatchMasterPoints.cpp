...
const CML::label CML::enrichedPatch::nFaceHits_ = 4;

// * * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * //

void CML::enrichedPatch::calcMasterPointFaces() const
{
...
const CML::Map<CML::labelList>& CML::enrichedPatch::masterPointFaces() const
{
    if (!masterPointFacesPtr_)
    {
