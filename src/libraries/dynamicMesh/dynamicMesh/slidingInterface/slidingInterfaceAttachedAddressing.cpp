...
void CML::slidingInterface::calcAttachedAddressing() const
{
    if (debug)
    {
        Pout<< "void CML::slidingInterface::calcAttachedAddressing() const "
            << " for object " << name() << " : "
...
void CML::slidingInterface::clearAttachedAddressing() const
{
...
void CML::slidingInterface::renumberAttachedAddressing
(
    const mapPolyMesh& m
) const
{
...
const CML::labelList& CML::slidingInterface::masterFaceCells() const
{
...
const CML::labelList& CML::slidingInterface::slaveFaceCells() const
{
...
const CML::labelList& CML::slidingInterface::masterStickOutFaces() const
{
...
const CML::labelList& CML::slidingInterface::slaveStickOutFaces() const
{
...
const CML::Map<CML::label>& CML::slidingInterface::retiredPointMap() const
{
