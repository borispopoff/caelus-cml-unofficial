...
const CML::scalar CML::slidingInterface::edgeCoPlanarTolDefault_ = 0.8;
...
void CML::slidingInterface::coupleInterface(polyTopoChange& ref) const
{
    if (debug)
    {
    ...
    // Please change consistently with slidingInterfaceProjectPoints.cpp
    //
    if (debug)
    {
