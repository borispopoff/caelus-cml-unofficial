...
//- Write edges
void CML::faceCoupleInfo::writeOBJ
(
...
void CML::faceCoupleInfo::writePointsFaces() const
{
...
void CML::faceCoupleInfo::writeEdges
(
...
CML::labelList CML::faceCoupleInfo::findMappedEdges
(
    const edgeList& edges,
...
// polyPatches.
bool CML::faceCoupleInfo::regionEdge
(
...
void CML::faceCoupleInfo::setCutEdgeToPoints(const labelList& cutToMasterEdges)
{
...
CML::label CML::faceCoupleInfo::matchFaces
(
    const scalar absTol,
    const pointField& points0,
    const face& f0,
...
)
{
    ...
    forAll(f0, startFp)
    {
        ...
        forAll(f1, i)
        {
            scalar distSqr = CML::magSqr(points0[f0[fp0]] - points1[f1[fp1]]);
...
bool CML::faceCoupleInfo::matchPointsThroughFaces
(
    const scalar absTol,
...
CML::scalar CML::faceCoupleInfo::maxDistance
(
    const face& cutF,
    const pointField& cutPoints,
    const face& masterF,
...
void CML::faceCoupleInfo::findPerfectMatchingFaces
(
...
void CML::faceCoupleInfo::findSlavesCoveringMaster
(
    const primitiveMesh& mesh0,
    const primitiveMesh& mesh1,
    const scalar absTol,
...
)
{
    ...
    )
    {
        ...
        pointIndexHit nearInfo = tree.findNearest(fc, CML::sqr(absTol));
...
CML::label CML::faceCoupleInfo::growCutFaces
(
    const labelList& cutToMasterEdges,
...
void CML::faceCoupleInfo::checkMatch(const labelList& cutToMasterEdges) const
{
...
CML::label CML::faceCoupleInfo::matchEdgeFaces
(
    const labelList& cutToMasterEdges,
    Map<labelList>& candidates
)
...
CML::label CML::faceCoupleInfo::geometricMatchEdgeFaces
(
    Map<labelList>& candidates
)
{
...
void CML::faceCoupleInfo::perfectPointMatch
(
    const scalar absTol,
...
void CML::faceCoupleInfo::subDivisionMatch
(
    const polyMesh& slaveMesh,
    const bool patchDivision,
    const scalar absTol
...
CML::faceCoupleInfo::faceCoupleInfo
(
...
CML::labelList CML::faceCoupleInfo::faceLabels(const polyPatch& pp)
{
...
CML::Map<CML::label> CML::faceCoupleInfo::makeMap(const labelList& lst)
{
...
CML::Map<CML::labelList> CML::faceCoupleInfo::makeMap
(
