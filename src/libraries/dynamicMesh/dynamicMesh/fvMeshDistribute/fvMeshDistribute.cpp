...
void CML::fvMeshDistribute::inplaceRenumberWithFlip
(
...
)
{
    ...
    {
        CML::inplaceRenumber(oldToNew, lst);
    }
    else
    {
...
CML::labelList CML::fvMeshDistribute::select
(
...
void CML::fvMeshDistribute::checkEqualWordList
(
    const string& msg,
    const wordList& lst
)
...
CML::wordList CML::fvMeshDistribute::mergeWordList(const wordList& procNames)
{
    List<wordList> allNames(Pstream::nProcs());
...
void CML::fvMeshDistribute::printMeshInfo(const fvMesh& mesh)
{
    Pout<< "Primitives:" << nl
...
void CML::fvMeshDistribute::printCoupleInfo
(
...
CML::label CML::fvMeshDistribute::findNonEmptyPatch() const
{
...
// non-processor patch.
CML::autoPtr<CML::mapPolyMesh> CML::fvMeshDistribute::deleteProcPatches
(
...
// Repatch the mesh.
CML::autoPtr<CML::mapPolyMesh> CML::fvMeshDistribute::repatch
(
...
void CML::fvMeshDistribute::findCouples
(
    const primitiveMesh& mesh,
    const labelList& sourceFace,
    const labelList& sourceProc,
...
CML::labelList CML::fvMeshDistribute::mapBoundaryData
(
...
void CML::fvMeshDistribute::addProcPatches
(
...
CML::labelList CML::fvMeshDistribute::getBoundaryPatch
(
...
void CML::fvMeshDistribute::sendMesh
(
    const label domain,
    const fvMesh& mesh,
...
CML::autoPtr<CML::fvMesh> CML::fvMeshDistribute::receiveMesh
(
    const label domain,
    const wordList& pointZoneNames,
    const wordList& faceZoneNames,
...
CML::fvMeshDistribute::fvMeshDistribute(fvMesh& mesh, const scalar mergeTol)
:
    mesh_(mesh),
    mergeTol_(mergeTol)
{}
...
CML::labelList CML::fvMeshDistribute::countCells
(
    const labelList& distribution
)
{
...
CML::autoPtr<CML::mapDistributePolyMesh> CML::fvMeshDistribute::distribute
(
    const labelList& distribution
)
{
