...
#include "movingConeTopoFvMesh.hpp"
#include "Time.hpp"
...
CML::tmp<CML::scalarField> CML::movingConeTopoFvMesh::vertexMarkup
(
    const pointField& p,
...
void CML::movingConeTopoFvMesh::addZonesAndModifiers()
{
...
CML::movingConeTopoFvMesh::movingConeTopoFvMesh(const IOobject& io)
:
    ...
    (
        motionVelAmplitude_*
        CML::sin(time().value()*pi/motionVelPeriod_)
    ),
...
CML::movingConeTopoFvMesh::~movingConeTopoFvMesh()
{}


// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //

bool CML::movingConeTopoFvMesh::update()
{
