...
CML::label CML::dynamicRefineFvMesh::count
(
...
void CML::dynamicRefineFvMesh::calculateProtectedCells
(
...
void CML::dynamicRefineFvMesh::readDict()
{
...
CML::autoPtr<CML::mapPolyMesh>
CML::dynamicRefineFvMesh::refine
(
...
// (an approximate) flux
CML::autoPtr<CML::mapPolyMesh>
CML::dynamicRefineFvMesh::unrefine
(
...
CML::scalarField
CML::dynamicRefineFvMesh::maxPointField(const scalarField& pFld) const
{
...
CML::scalarField
CML::dynamicRefineFvMesh::maxCellField(const volScalarField& vFld) const
{
...
CML::scalarField
CML::dynamicRefineFvMesh::cellToPoint(const scalarField& vFld) const
{
...
CML::scalarField CML::dynamicRefineFvMesh::error
(
...
void CML::dynamicRefineFvMesh::selectRefineCandidates
(
...
CML::labelList CML::dynamicRefineFvMesh::selectRefineCells
(
...
CML::labelList CML::dynamicRefineFvMesh::selectUnrefinePoints
(
...
void CML::dynamicRefineFvMesh::extendMarkedCells
(
...
CML::dynamicRefineFvMesh::dynamicRefineFvMesh(const IOobject& io)
:
    dynamicFvMesh(io),
    meshCutter_(*this),
    dumpLevel_(false),
...
CML::dynamicRefineFvMesh::~dynamicRefineFvMesh()
{}
...
bool CML::dynamicRefineFvMesh::writeObject
(
