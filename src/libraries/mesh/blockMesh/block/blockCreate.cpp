...
CML::label CML::block::vtxLabel(label i, label j, label k) const
{
    return
    (
        i
...
void CML::block::createPoints() const
{
...
void CML::block::createCells() const
{
    const label ni = meshDensity().x();
    const label nj = meshDensity().y();
    const label nk = meshDensity().z();
...
void CML::block::createBoundary() const
{
    const label ni = meshDensity().x();
    const label nj = meshDensity().y();
    const label nk = meshDensity().z();
