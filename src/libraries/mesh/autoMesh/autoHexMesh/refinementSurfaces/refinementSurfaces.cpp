...
namespace CML
{
    ...
    <
        CML::refinementSurfaces::areaSelectionAlgo,
        4
    >::names[] =
    {
        "inside",
...
const CML::NamedEnum<CML::refinementSurfaces::areaSelectionAlgo, 4>
    CML::refinementSurfaces::areaSelectionAlgoNames;
...
namespace CML
{
    ...
    const char* CML::NamedEnum
    <
        CML::refinementSurfaces::faceZoneType,
        3
    >::names[] =
    {
        "internal",
...
const CML::NamedEnum<CML::refinementSurfaces::faceZoneType, 3>
    CML::refinementSurfaces::faceZoneTypeNames;


// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

CML::refinementSurfaces::refinementSurfaces
(
...
CML::labelList CML::refinementSurfaces::getUnnamedSurfaces() const
{
...
CML::labelList CML::refinementSurfaces::getNamedSurfaces() const
{
...
CML::labelList CML::refinementSurfaces::getClosedNamedSurfaces() const
{
...
CML::labelList CML::refinementSurfaces::getInsidePointNamedSurfaces() const
{
    labelList closed(cellZoneNames_.size());
...
// CML::labelList CML::refinementSurfaces::countRegions(const triSurface& s)
// {
...
// void CML::refinementSurfaces::wantedRefinementLevel
// (
...
// surface.
void CML::refinementSurfaces::setMinLevelFields
(
    const shellSurfaces& shells
)
{
...
// number.
void CML::refinementSurfaces::findHigherIntersection
(
...
void CML::refinementSurfaces::findAllHigherIntersections
(
    const pointField& start,
    const pointField& end,
    const labelList& currentLevel,   // current cell refinement level
...
void CML::refinementSurfaces::findNearestIntersection
(
...
void CML::refinementSurfaces::findAnyIntersection
(
    const pointField& start,
    const pointField& end,
...
void CML::refinementSurfaces::findNearest
(
    const labelList& surfacesToTest,
...
void CML::refinementSurfaces::findNearestRegion
(
    const labelList& surfacesToTest,
    const pointField& samples,
    const scalarField& nearestDistSqr,
...
//CML::label CML::refinementSurfaces::findHighestIntersection
//(
//    const point& start,
//    const point& end,
...
void CML::refinementSurfaces::findInside
(
