...
#include "addPatchCellLayer.hpp"
#include "mapDistributePolyMesh.hpp"
#include "OFstream.hpp"
#include "layerParameters.hpp"
#include "combineFaces.hpp"
#include "IOmanip.hpp"
...
void CML::autoLayerDriver::dumpDisplacement
(
...
// points in pointSet.
void CML::autoLayerDriver::checkManifold
(
...
void CML::autoLayerDriver::checkMeshManifold() const
{
...
bool CML::autoLayerDriver::unmarkExtrusion
(
...
void CML::autoLayerDriver::handleNonManifolds
(
    const indirectPrimitivePatch& pp,
...
void CML::autoLayerDriver::handleFeatureAngle
(
    const indirectPrimitivePatch& pp,
    const labelList& meshEdges,
    const scalar minCos,
...
// the face.
void CML::autoLayerDriver::handleWarpedFaces
(
    const indirectPrimitivePatch& pp,
...
void CML::autoLayerDriver::growNoExtrusion
(
    const indirectPrimitivePatch& pp,
    pointField& patchDisp,
    labelList& patchNLayers,
...
void CML::autoLayerDriver::determineSidePatches
(
...
void CML::autoLayerDriver::calculateLayerThickness
(
    const indirectPrimitivePatch& pp,
    const labelList& patchIDs,
...
void CML::autoLayerDriver::syncPatchDisplacement
(
...
// patch point.
void CML::autoLayerDriver::getPatchDisplacement
(
    const motionSmoother& meshMover,
...
bool CML::autoLayerDriver::sameEdgeNeighbour
(
...
void CML::autoLayerDriver::getVertexString
(
    const indirectPrimitivePatch& pp,
    const labelListList& globalEdgeFaces,
    const label facei,
...
CML::label CML::autoLayerDriver::truncateDisplacement
(
    const globalIndex& globalFaces,
    const labelListList& edgeGlobalFaces,
    const motionSmoother& meshMover,
...
void CML::autoLayerDriver::setupLayerInfoTruncation
(
    const motionSmoother& meshMover,
    const labelList& patchNLayers,
    const List<extrudeMode>& extrudeStatus,
...
bool CML::autoLayerDriver::cellsUseFace
(
    const polyMesh& mesh,
...
CML::label CML::autoLayerDriver::checkAndUnmark
(
...
CML::label CML::autoLayerDriver::countExtrusion
(
    const indirectPrimitivePatch& pp,
    const List<extrudeMode>& extrudeStatus
)
...
void CML::autoLayerDriver::getLayerCellsFaces
(
    const polyMesh& mesh,
    const addPatchCellLayer& addLayer,
...
CML::autoLayerDriver::autoLayerDriver
(
...
void CML::autoLayerDriver::mergePatchFacesUndo
(
    const layerParameters& layerParams,
...
{
    scalar minCos =
        CML::cos(degToRad(layerParams.featureAngle()));

    scalar concaveCos =
        CML::cos(degToRad(layerParams.concaveAngle()));
...
void CML::autoLayerDriver::addLayers
(
    const layerParameters& layerParams,
    const dictionary& motionDict,
    const labelList& patchIDs,
...
void CML::autoLayerDriver::doLayers
(
