...
void CML::meshRefinement::getBafflePatches
(
...
CML::Map<CML::label> CML::meshRefinement::getZoneBafflePatches
(
...
CML::autoPtr<CML::mapPolyMesh> CML::meshRefinement::createBaffles
(
...
CML::List<CML::labelPair> CML::meshRefinement::getDuplicateFaces
(
...
CML::autoPtr<CML::mapPolyMesh> CML::meshRefinement::createZoneBaffles
(
    const labelList& globalToPatch,
...
// region.
CML::List<CML::labelPair> CML::meshRefinement::filterDuplicateFaces
(
...
CML::autoPtr<CML::mapPolyMesh> CML::meshRefinement::mergeBaffles
(
    const List<labelPair>& couples
)
{
...
void CML::meshRefinement::findCellZoneGeometric
(
...
//   namedSurfaceIndex.
void CML::meshRefinement::findCellZoneTopo
(
...
void CML::meshRefinement::makeConsistentFaceIndex
(
...
void CML::meshRefinement::baffleAndSplitMesh
(
...
CML::autoPtr<CML::mapPolyMesh> CML::meshRefinement::splitMesh
(
...
// Zoning
CML::autoPtr<CML::mapPolyMesh> CML::meshRefinement::zonify
(
    const point& keepPoint,
