...
//CML::label CML::meshRefinement::mergePatchFaces
//(
//    const scalar minCos,
...
//CML::autoPtr<CML::mapPolyMesh> CML::meshRefinement::mergeEdges
//(
//    const scalar minCos
//)
//{
...
CML::label CML::meshRefinement::mergePatchFacesUndo
(
    const scalar minCos,
    const scalar concaveCos,
    const labelList& patchIDs,
...
CML::autoPtr<CML::mapPolyMesh> CML::meshRefinement::doRemovePoints
(
...
CML::autoPtr<CML::mapPolyMesh> CML::meshRefinement::doRestorePoints
(
    removePoints& pointRemover,
...
CML::labelList CML::meshRefinement::collectFaces
(
...
CML::labelList CML::meshRefinement::growFaceCellFace
(
    const labelHashSet& set
) const
{
...
// Remove points not used by any face or points used by only two faces where
// the edges are in line
CML::label CML::meshRefinement::mergeEdgesUndo
(
    const scalar minCos,
    const dictionary& motionDict
)
