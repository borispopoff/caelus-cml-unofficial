...
void CML::meshRefinement::calcNeighbourData
(
    labelList& neiLevel,
    pointField& neiCc
)  const
...
void CML::meshRefinement::updateIntersections(const labelList& changedFaces)
{
    const pointField& cellCentres = mesh_.cellCentres();
...
void CML::meshRefinement::testSyncPointList
(
    const string& msg,
    const polyMesh& mesh,
...
void CML::meshRefinement::checkData()
{
...
void CML::meshRefinement::setInstance(const fileName& inst)
{
...
CML::autoPtr<CML::mapPolyMesh> CML::meshRefinement::doRemoveCells
(
...
//// numbered processor.
//void CML::meshRefinement::getCoupledRegionMaster
//(
...
//
//
//void CML::meshRefinement::calcLocalRegions
//(
//    const globalIndex& globalCells,
...
//
//
//CML::label CML::meshRefinement::getShiftedRegion
//(
...
//void CML::meshRefinement::addUnique(const label elem, labelList& lst)
//{
...
//
//
//void CML::meshRefinement::calcRegionRegions
//(
//    const labelList& globalRegion,
//    const Map<label>& globalToLocalRegion,
//    const Map<label>& coupledRegionToMaster,
...
CML::meshRefinement::meshRefinement
(
    fvMesh& mesh,
...
CML::label CML::meshRefinement::countHits() const
{
    // Stats on edges to test. Count proc faces only once.
    PackedBoolList isMasterFace(syncTools::getMasterFaces(mesh_));
...
//CML::labelList CML::meshRefinement::decomposeCombineRegions
//(
//    const scalarField& cellWeights,
//    const boolList& blockedFace,
...
CML::autoPtr<CML::mapDistributePolyMesh> CML::meshRefinement::balance
(
...
CML::labelList CML::meshRefinement::intersectedFaces() const
{
...
CML::labelList CML::meshRefinement::intersectedPoints() const
{
...
CML::autoPtr<CML::indirectPrimitivePatch> CML::meshRefinement::makePatch
(
    const polyMesh& mesh,
...
CML::tmp<CML::pointVectorField> CML::meshRefinement::makeDisplacementField
(
...
void CML::meshRefinement::checkCoupledFaceZones(const polyMesh& mesh)
{
...
CML::label CML::meshRefinement::addPatch
(
    fvMesh& mesh,
    const word& patchName,
...
CML::label CML::meshRefinement::addMeshedPatch
(
    const word& name,
    const dictionary& patchInfo
)
...
CML::labelList CML::meshRefinement::meshedPatches() const
{
    const polyBoundaryMesh& patches = mesh_.boundaryMesh();
...
void CML::meshRefinement::selectSeparatedCoupledFaces(boolList& selected) const
{
    const polyBoundaryMesh& patches = mesh_.boundaryMesh();
...
CML::autoPtr<CML::mapPolyMesh> CML::meshRefinement::splitMeshRegions
(
...
void CML::meshRefinement::distribute(const mapDistributePolyMesh& map)
{
...
void CML::meshRefinement::updateMesh
(
...
void CML::meshRefinement::storeData
(
...
bool CML::meshRefinement::write() const
{
    bool writeOk =
        mesh_.write()
     && meshCutter_.write()
...
void CML::meshRefinement::printMeshInfo(const bool debug, const string& msg)
 const
{
...
CML::word CML::meshRefinement::timeName() const
{
...
void CML::meshRefinement::dumpRefinementLevel() const
{
...
void CML::meshRefinement::dumpIntersections(const fileName& prefix) const
{
    {
        const pointField& cellCentres = mesh_.cellCentres();
