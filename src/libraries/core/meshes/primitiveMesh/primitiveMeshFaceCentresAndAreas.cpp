...
void CML::primitiveMesh::calcFaceCentresAndAreas() const
{
    if (debug)
    {
...
void CML::primitiveMesh::makeFaceCentresAndAreas
(
    const pointField& p,
    vectorField& fCtrs,
    vectorField& fAreas
...
const CML::vectorField& CML::primitiveMesh::faceCentres() const
{
    if (!faceCentresPtr_)
    {
...
const CML::vectorField& CML::primitiveMesh::faceAreas() const
{
    if (!faceAreasPtr_)
    {
        calcFaceCentresAndAreas();
