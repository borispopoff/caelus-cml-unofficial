...
void CML::primitiveMesh::calcEdges(const bool doFaceEdges) const
{
    if (debug)
    {
...
CML::label CML::primitiveMesh::findFirstCommonElementFromSortedLists
(
...
const CML::edgeList& CML::primitiveMesh::edges() const
{
    if (!edgesPtr_)
    {
        //calcEdges(true);
...
const CML::labelListList& CML::primitiveMesh::pointEdges() const
{
    if (!pePtr_)
    {
        //calcEdges(true);
...
const CML::labelListList& CML::primitiveMesh::faceEdges() const
{
    if (!fePtr_)
    {
        if (debug)
...
void CML::primitiveMesh::clearOutEdges()
{
...
const CML::labelList& CML::primitiveMesh::faceEdges
(
    const label facei,
...
const CML::labelList& CML::primitiveMesh::faceEdges(const label facei) const
{
    return faceEdges(facei, labels_);
}


const CML::labelList& CML::primitiveMesh::cellEdges
(
    const label celli,
    DynamicList<label>& storage
) const
...
const CML::labelList& CML::primitiveMesh::cellEdges(const label celli) const
{
