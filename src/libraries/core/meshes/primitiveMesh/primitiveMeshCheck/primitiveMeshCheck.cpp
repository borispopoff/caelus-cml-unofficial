...
CML::scalar CML::primitiveMesh::closedThreshold_  = 1.0e-6;
CML::scalar CML::primitiveMesh::aspectThreshold_  = 1000;
CML::scalar CML::primitiveMesh::nonOrthThreshold_ = 70;    // deg
CML::scalar CML::primitiveMesh::skewThreshold_    = 4;
CML::scalar CML::primitiveMesh::planarCosAngle_   = 1.0e-6;


// * * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * //

bool CML::primitiveMesh::checkClosedBoundary
(
...
bool CML::primitiveMesh::checkClosedCells
(
...
bool CML::primitiveMesh::checkFaceAreas
(
    const vectorField& faceAreas,
    const bool report,
...
bool CML::primitiveMesh::checkCellVolumes
(
...
bool CML::primitiveMesh::checkFaceOrthogonality
(
...
bool CML::primitiveMesh::checkFacePyramids
(
...
bool CML::primitiveMesh::checkFaceSkewness
(
    const pointField& points,
...
bool CML::primitiveMesh::checkFaceAngles
(
    const pointField& points,
    const vectorField& faceAreas,
    const bool report,
...
bool CML::primitiveMesh::checkFaceFlatness
(
    const pointField& points,
...
bool CML::primitiveMesh::checkConcaveCells
(
    const vectorField& fAreas,
...
bool CML::primitiveMesh::checkUpperTriangular
(
    const bool report,
    labelHashSet* setPtr
) const
...
bool CML::primitiveMesh::checkCellsZipUp
(
    const bool report,
    labelHashSet* setPtr
) const
...
bool CML::primitiveMesh::checkFaceVertices
(
    const bool report,
    labelHashSet* setPtr
) const
...
bool CML::primitiveMesh::checkPoints
(
    const bool report,
    labelHashSet* setPtr
) const
...
bool CML::primitiveMesh::checkDuplicateFaces
(
    const label facei,
...
bool CML::primitiveMesh::checkFaceFaces
(
    const bool report,
    labelHashSet* setPtr
) const
...
bool CML::primitiveMesh::checkClosedBoundary(const bool report) const
{
...
bool CML::primitiveMesh::checkTopology(const bool report) const
{
...
bool CML::primitiveMesh::checkGeometry(const bool report) const
{
    label noFailedChecks = 0;
...
bool CML::primitiveMesh::checkMesh(const bool report) const
{
    if (debug)
    {
...
CML::scalar CML::primitiveMesh::setClosedThreshold(const scalar val)
{
...
CML::scalar CML::primitiveMesh::setAspectThreshold(const scalar val)
{
...
CML::scalar CML::primitiveMesh::setNonOrthThreshold(const scalar val)
{
...
CML::scalar CML::primitiveMesh::setSkewThreshold(const scalar val)
{
