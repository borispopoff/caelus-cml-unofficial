...
CML::label CML::globalPoints::findSamePoint
(
...
CML::labelPairList CML::globalPoints::addSendTransform
(
    const label patchI,
...
CML::label CML::globalPoints::meshToLocalPoint
(
...
CML::label CML::globalPoints::localToMeshPoint
(
...
void CML::globalPoints::printProcPoint
(
    const labelList& patchToMeshPoint,
...
void CML::globalPoints::printProcPoints
(
    const labelList& patchToMeshPoint,
...
CML::labelList CML::globalPoints::reverseMeshPoints
(
...
void CML::globalPoints::calculateSharedPoints
(
    const Map<label>& meshToPatchPoint, // from mesh point to local numbering
