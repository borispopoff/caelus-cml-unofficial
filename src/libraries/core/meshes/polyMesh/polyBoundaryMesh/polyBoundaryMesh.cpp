...
void CML::polyBoundaryMesh::clearAddressing()
{
...
void CML::polyBoundaryMesh::calcGeometry()
{
...
const CML::List<CML::labelPairList>&
CML::polyBoundaryMesh::neighbourEdges() const
{
    if (Pstream::parRun())
    {
        WarningInFunction
...
const CML::labelList& CML::polyBoundaryMesh::patchID() const
{
...
CML::wordList CML::polyBoundaryMesh::names() const
{
    const polyPatchList& patches = *this;
...
CML::wordList CML::polyBoundaryMesh::types() const
{
    const polyPatchList& patches = *this;
...
CML::wordList CML::polyBoundaryMesh::physicalTypes() const
{
    const polyPatchList& patches = *this;
...
CML::label CML::polyBoundaryMesh::findIndex(const keyType& key) const
{
    if (!key.empty())
    {
        if (key.isPattern())
...
CML::label CML::polyBoundaryMesh::findPatchID(const word& patchName) const
{
    const polyPatchList& patches = *this;
...
CML::label CML::polyBoundaryMesh::whichPatch(const label faceIndex) const
{
...
bool CML::polyBoundaryMesh::checkParallelSync(const bool report) const
{
    if (!Pstream::parRun())
    {
        return false;
...
bool CML::polyBoundaryMesh::checkDefinition(const bool report) const
{
...
void CML::polyBoundaryMesh::movePoints(const pointField& p)
{
    PstreamBuffers pBufs(Pstream::defaultCommsType);
...
void CML::polyBoundaryMesh::updateMesh()
{
    neighbourEdgesPtr_.clear();
    patchIDPtr_.clear();
    groupPatchIDsPtr_.clear();
...
bool CML::polyBoundaryMesh::writeData(Ostream& os) const
{
    const polyPatchList& patches = *this;
...
bool CML::polyBoundaryMesh::writeObject
(
...
CML::polyPatch& CML::polyBoundaryMesh::operator[]
(
    const word& patchName
)
{
...
CML::Ostream& CML::operator<<(Ostream& os, const polyBoundaryMesh& pbm)
{
    pbm.writeData(os);
    return os;
}
