...
void CML::mapDistributePolyMesh::calcPatchSizes()
{
...
CML::mapDistributePolyMesh::mapDistributePolyMesh()
:
    nOldPoints_(0),
    nOldFaces_(0),
    nOldCells_(0),
...
CML::mapDistributePolyMesh::mapDistributePolyMesh(Istream& is)
{
    is  >> *this;
}
...
void CML::mapDistributePolyMesh::transfer(mapDistributePolyMesh& rhs)
{
...
void CML::mapDistributePolyMesh::distributePointIndices(labelList& lst) const
{
...
void CML::mapDistributePolyMesh::distributeFaceIndices(labelList& lst) const
{
    // Construct boolList from selected elements
    boolList isSelected
    (
...
void CML::mapDistributePolyMesh::distributeCellIndices(labelList& lst) const
{
    // Construct boolList from selected elements
    boolList isSelected
    (
...
void CML::mapDistributePolyMesh::distributePatchIndices(labelList& lst) const
{
    // Construct boolList from selected elements
    boolList isSelected
    (
...
void CML::mapDistributePolyMesh::operator=(const mapDistributePolyMesh& rhs)
{
    nOldPoints_ = rhs.nOldPoints_;
    nOldFaces_ = rhs.nOldFaces_;
    nOldCells_ = rhs.nOldCells_;
...
void CML::mapDistributePolyMesh::operator=(mapDistributePolyMesh&& rhs)
{
    nOldPoints_ = rhs.nOldPoints_;
    nOldFaces_ = rhs.nOldFaces_;
    nOldCells_ = rhs.nOldCells_;
...
CML::Istream& CML::operator>>(Istream& is, mapDistributePolyMesh& map)
{
...
CML::Ostream& CML::operator<<(Ostream& os, const mapDistributePolyMesh& map)
{
    os  << map.nOldPoints_
