...
CML::label CML::coupleGroupIdentifier::findOtherPatchID
(
    const polyMesh& mesh,
...
CML::coupleGroupIdentifier::coupleGroupIdentifier()
:
    name_()
{}


CML::coupleGroupIdentifier::coupleGroupIdentifier(const word& name)
:
    name_(name)
{}


CML::coupleGroupIdentifier::coupleGroupIdentifier(const dictionary& dict)
:
...
void CML::coupleGroupIdentifier::write(Ostream& os) const
{
    if (valid())
    {
...
CML::Ostream& CML::operator<<(Ostream& os, const coupleGroupIdentifier& p)
{
    p.write(os);
