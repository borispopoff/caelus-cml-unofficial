...
const char* const CML::cell::typeName = "cell";

// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //

CML::labelList CML::cell::labels(const faceUList& f) const
{
...
CML::pointField CML::cell::points
(
    const faceUList& f,
...
CML::edgeList CML::cell::edges(const faceUList& f) const
{
...
bool CML::operator==(const cell& a, const cell& b)
{
