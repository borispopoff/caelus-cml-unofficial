...
CML::label CML::cellMatcher::calcLocalFaces
(
...
void CML::cellMatcher::calcEdgeAddressing(const label numVert)
{
    edgeFaces_ = -1;
...
void CML::cellMatcher::write(CML::Ostream& os) const
{
    os  << "Faces:" << endl;
