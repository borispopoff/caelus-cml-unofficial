...
const CML::label CML::wedgeMatcher::vertPerCell = 7;
const CML::label CML::wedgeMatcher::facePerCell = 6;
const CML::label CML::wedgeMatcher::maxVertPerFace = 4;


// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

CML::wedgeMatcher::wedgeMatcher()
:
    cellMatcher
    (
        vertPerCell,
...
bool CML::wedgeMatcher::matchShape
(
...
CML::label CML::wedgeMatcher::faceHashValue() const
{
    return 2*3 + 4*4;
}


bool CML::wedgeMatcher::faceSizeMatch
(
    const faceList& faces,
    const labelList& myFaces
) const
...
bool CML::wedgeMatcher::isA(const faceList& faces)
{
