...
const CML::label CML::tetMatcher::vertPerCell = 4;
const CML::label CML::tetMatcher::facePerCell = 4;
const CML::label CML::tetMatcher::maxVertPerFace = 3;


// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

CML::tetMatcher::tetMatcher()
:
    cellMatcher
    (
        vertPerCell,
...
bool CML::tetMatcher::matchShape
(
...
CML::label CML::tetMatcher::faceHashValue() const
{
    return 4*3;
}


bool CML::tetMatcher::faceSizeMatch
(
    const faceList& faces,
    const labelList& myFaces
) const
...
bool CML::tetMatcher::isA(const faceList& faces)
{
