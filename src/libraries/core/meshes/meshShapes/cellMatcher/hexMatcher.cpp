...
const CML::label CML::hexMatcher::vertPerCell = 8;
const CML::label CML::hexMatcher::facePerCell = 6;
const CML::label CML::hexMatcher::maxVertPerFace = 4;


// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

CML::hexMatcher::hexMatcher()
:
    cellMatcher
    (
        vertPerCell,
...
bool CML::hexMatcher::matchShape
(
...
CML::label CML::hexMatcher::faceHashValue() const
{
    return facePerCell*vertPerCell;
}


bool CML::hexMatcher::faceSizeMatch
(
    const faceList& faces,
    const labelList& myFaces
) const
...
bool CML::hexMatcher::isA(const faceList& faces)
{
