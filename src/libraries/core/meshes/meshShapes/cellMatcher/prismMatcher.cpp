...
const CML::label CML::prismMatcher::vertPerCell = 6;
const CML::label CML::prismMatcher::facePerCell = 5;
const CML::label CML::prismMatcher::maxVertPerFace = 4;


// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

CML::prismMatcher::prismMatcher()
:
    cellMatcher
    (
        vertPerCell,
...
bool CML::prismMatcher::matchShape
(
...
CML::label CML::prismMatcher::faceHashValue() const
{
    return 2*3 + 4*4;
}


bool CML::prismMatcher::faceSizeMatch
(
    const faceList& faces,
    const labelList& myFaces
) const
...
bool CML::prismMatcher::isA(const faceList& faces)
{
