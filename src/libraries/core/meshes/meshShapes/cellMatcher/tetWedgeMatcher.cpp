...
const CML::label CML::tetWedgeMatcher::vertPerCell = 5;
const CML::label CML::tetWedgeMatcher::facePerCell = 4;
const CML::label CML::tetWedgeMatcher::maxVertPerFace = 4;


// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

CML::tetWedgeMatcher::tetWedgeMatcher()
:
    cellMatcher
    (
        vertPerCell,
...
bool CML::tetWedgeMatcher::matchShape
(
...
CML::label CML::tetWedgeMatcher::faceHashValue() const
{
    return 2*3 + 2*4;
}


bool CML::tetWedgeMatcher::faceSizeMatch
(
    const faceList& faces,
    const labelList& myFaces
) const
...
bool CML::tetWedgeMatcher::isA(const faceList& faces)
{
