...
const char* const CML::face::typeName = "face";
...
CML::label CML::face::mostConcaveAngle
(
...
) const
{
    ...
    else
    {
        ...
        for (label i = 0; i < size() - 3; i++)
        {
            ...
            splitEdge /= CML::mag(splitEdge) + VSMALL;
...
int CML::face::compare(const face& a, const face& b)
{
...
CML::point CML::face::centre(const pointField& points) const
{
...
CML::label CML::face::which(const label globalIndex) const
{
    const labelList& f = *this;
...
CML::edgeList CML::face::edges() const
{
...
int CML::face::edgeDirection(const edge& e) const
{
    forAll(*this, i)
    {
...
CML::label CML::face::nTriangles(const pointField&) const
{
    return nTriangles();
}
...
CML::label CML::face::nTrianglesQuads
(
    const pointField& points,
    label& triI,
    label& quadI
...
CML::label CML::face::trianglesQuads
(
    const pointField& points,
    label& triI,
    label& quadI,
