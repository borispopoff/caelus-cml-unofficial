...
public:
    ...
    :
        ::CML::simpleRegIOobject(CML::debug::addDimensionSetObject, name)
    {}
...
CML::dimensionSets::dimensionSets
(
...
void CML::dimensionSets::coefficients(scalarField& exponents) const
{
