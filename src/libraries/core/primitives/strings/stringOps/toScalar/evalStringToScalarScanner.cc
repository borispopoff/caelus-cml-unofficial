...
#line 177 "evalStringToScalarScanner.rl"
...
#line 241 "evalStringToScalarScanner.rl"
...
#line 1 "NONE"
	{ts = p;}
#line 427 "evalStringToScalarScanner.cc"
	switch( (*p) ) {
		case 32: goto st8;
		case 33: goto st9;
		case 37: goto tr10;
...
st12:
	if ( ++p == pe )
		goto _test_eof12;
case 12:
#line 556 "evalStringToScalarScanner.cc"
	switch( (*p) ) {
		case 46: goto tr2;
		case 69: goto st3;
		case 101: goto st3;
...
st16:
	if ( ++p == pe )
		goto _test_eof16;
case 16:
#line 761 "evalStringToScalarScanner.cc"
	if ( (*p) == 95 )
		goto tr51;
	if ( (*p) < 65 ) {
		if ( 48 <= (*p) && (*p) <= 57 )
...
#line 243 "evalStringToScalarScanner.rl"
  /* ^^^ FSM execution here ^^^ */;
