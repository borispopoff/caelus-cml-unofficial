...
#line 220 "evalStringToScalarScanner.rl"
...
#line 69 "evalStringToScalarScanner.rl"
	...
	goto st4;
tr31:
#line 92 "evalStringToScalarScanner.rl"
	{te = p;p--;{
        driver.parsePosition() = (ts-buf);
...
#line 1 "NONE"
	{ts = p;}
#line 370 "evalStringToScalarScanner.cc"
	switch( (*p) ) {
		case 32: goto st5;
		case 40: goto tr6;
		case 41: goto tr7;
...
st6:
	if ( ++p == pe )
		goto _test_eof6;
case 6:
#line 434 "evalStringToScalarScanner.cc"
	switch( (*p) ) {
		case 69: goto st2;
		case 101: goto st2;
	}
...
st8:
	if ( ++p == pe )
		goto _test_eof8;
case 8:
#line 475 "evalStringToScalarScanner.cc"
	switch( (*p) ) {
		case 46: goto tr0;
		case 69: goto st2;
		case 101: goto st2;
...
st10:
	if ( ++p == pe )
		goto _test_eof10;
case 10:
#line 641 "evalStringToScalarScanner.cc"
	if ( (*p) == 95 )
		goto tr32;
	if ( (*p) < 65 ) {
		if ( 48 <= (*p) && (*p) <= 57 )
...
#line 222 "evalStringToScalarScanner.rl"
  /* ^^^ FSM execution here ^^^ */;
