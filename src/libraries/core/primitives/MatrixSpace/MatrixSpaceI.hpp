...
template<class Form, class Cmpt, CML::direction Mrows, CML::direction Ncols>
inline CML::MatrixSpace<Form, Cmpt, Mrows, Ncols>::MatrixSpace()
{}
...
template<class Form, class Cmpt, CML::direction Mrows, CML::direction Ncols>
inline CML::MatrixSpace<Form, Cmpt, Mrows, Ncols>::MatrixSpace(Istream& is)
:
...
template<class Form, class Cmpt, CML::direction Mrows, CML::direction Ncols>
template<class SubTensor, CML::direction BRowStart, CML::direction BColStart>
...
template<class Form, class Cmpt, CML::direction Mrows, CML::direction Ncols>
inline const Cmpt& CML::MatrixSpace<Form, Cmpt, Mrows, Ncols>::xx() const
{
    return elmt<0, 0>();
}
...
template<class Form, class Cmpt, CML::direction Mrows, CML::direction Ncols>
inline Cmpt& CML::MatrixSpace<Form, Cmpt, Mrows, Ncols>::xx()
{
    return elmt<0, 0>();
}
...
template<class Form, class Cmpt, CML::direction Mrows, CML::direction Ncols>
inline const Cmpt& CML::MatrixSpace<Form, Cmpt, Mrows, Ncols>::xy() const
{
    return elmt<0,1>();
}
...
template<class Form, class Cmpt, CML::direction Mrows, CML::direction Ncols>
inline Cmpt& CML::MatrixSpace<Form, Cmpt, Mrows, Ncols>::xy()
{
    return elmt<0,1>();
}
...
template<class Form, class Cmpt, CML::direction Mrows, CML::direction Ncols>
inline const Cmpt& CML::MatrixSpace<Form, Cmpt, Mrows, Ncols>::xz() const
{
    return elmt<0,2>();
}
...
template<class Form, class Cmpt, CML::direction Mrows, CML::direction Ncols>
inline Cmpt& CML::MatrixSpace<Form, Cmpt, Mrows, Ncols>::xz()
{
    return elmt<0,2>();
}
...
template<class Form, class Cmpt, CML::direction Mrows, CML::direction Ncols>
inline const Cmpt& CML::MatrixSpace<Form, Cmpt, Mrows, Ncols>::yx() const
{
    return elmt<1,0>();
}
...
template<class Form, class Cmpt, CML::direction Mrows, CML::direction Ncols>
inline Cmpt& CML::MatrixSpace<Form, Cmpt, Mrows, Ncols>::yx()
{
    return elmt<1,0>();
}
...
template<class Form, class Cmpt, CML::direction Mrows, CML::direction Ncols>
inline const Cmpt& CML::MatrixSpace<Form, Cmpt, Mrows, Ncols>::yy() const
{
    return elmt<1,1>();
}
...
template<class Form, class Cmpt, CML::direction Mrows, CML::direction Ncols>
inline Cmpt& CML::MatrixSpace<Form, Cmpt, Mrows, Ncols>::yy()
{
    return elmt<1,1>();
}
...
template<class Form, class Cmpt, CML::direction Mrows, CML::direction Ncols>
inline const Cmpt& CML::MatrixSpace<Form, Cmpt, Mrows, Ncols>::yz() const
{
    return elmt<1,2>();
}
...
template<class Form, class Cmpt, CML::direction Mrows, CML::direction Ncols>
inline Cmpt& CML::MatrixSpace<Form, Cmpt, Mrows, Ncols>::yz()
{
    return elmt<1,2>();
}
...
template<class Form, class Cmpt, CML::direction Mrows, CML::direction Ncols>
inline const Cmpt& CML::MatrixSpace<Form, Cmpt, Mrows, Ncols>::zx() const
{
    return elmt<2,0>();
}
...
template<class Form, class Cmpt, CML::direction Mrows, CML::direction Ncols>
inline Cmpt& CML::MatrixSpace<Form, Cmpt, Mrows, Ncols>::zx()
{
    return elmt<2,0>();
}
...
template<class Form, class Cmpt, CML::direction Mrows, CML::direction Ncols>
inline const Cmpt& CML::MatrixSpace<Form, Cmpt, Mrows, Ncols>::zy() const
{
    return elmt<2,1>();
}
...
template<class Form, class Cmpt, CML::direction Mrows, CML::direction Ncols>
inline Cmpt& CML::MatrixSpace<Form, Cmpt, Mrows, Ncols>::zy()
{
    return elmt<2,1>();
}
...
template<class Form, class Cmpt, CML::direction Mrows, CML::direction Ncols>
inline const Cmpt& CML::MatrixSpace<Form, Cmpt, Mrows, Ncols>::zz() const
{
    return elmt<2,2>();
}

template<class Form, class Cmpt, CML::direction Mrows, CML::direction Ncols>
inline Cmpt& CML::MatrixSpace<Form, Cmpt, Mrows, Ncols>::zz()
{
    return elmt<2,2>();
}
...
template<class Form, class Cmpt, CML::direction Mrows, CML::direction Ncols>
inline typename CML::typeOfTranspose<Cmpt, Form>::type
CML::MatrixSpace<Form, Cmpt, Mrows, Ncols>::T() const
{
...
<
    ...
    CML::direction BColStart
>
inline typename CML::MatrixSpace<Form, Cmpt, Mrows, Ncols>::template
    ConstBlock<SubTensor, BRowStart, BColStart>
CML::MatrixSpace<Form, Cmpt, Mrows, Ncols>::block() const
{
    return *this;
}
...
>
inline
typename CML::MatrixSpace<Form, Cmpt, Mrows, Ncols>::template
    Block<SubTensor, BRowStart, BColStart>
CML::MatrixSpace<Form, Cmpt, Mrows, Ncols>::block()
{
    return *this;
}
...
template<class Form, class Cmpt, CML::direction Mrows, CML::direction Ncols>
inline const Cmpt& CML::MatrixSpace<Form, Cmpt, Mrows, Ncols>::operator()
(
    const direction& i,
    const direction& j
) const
...
template<class Form, class Cmpt, CML::direction Mrows, CML::direction Ncols>
inline Cmpt& CML::MatrixSpace<Form, Cmpt, Mrows, Ncols>::operator()
(
    const direction& i,
    const direction& j
)
...
template<class SubTensor, CML::direction BRowStart, CML::direction BColStart>
inline SubTensor
CML::MatrixSpace<Form, Cmpt, Mrows, Ncols>::
ConstBlock<SubTensor, BRowStart, BColStart>::
operator()() const
{
    return *this;
...
template<class Form, class Cmpt, CML::direction Mrows, CML::direction Ncols>
inline void CML::MatrixSpace<Form, Cmpt, Mrows, Ncols>::operator=
(
    const CML::zero
)
{
