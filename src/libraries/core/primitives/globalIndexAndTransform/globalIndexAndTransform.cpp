...
CML::label CML::globalIndexAndTransform::matchTransform
(
...
void CML::globalIndexAndTransform::determineTransforms()
{
...
void CML::globalIndexAndTransform::determineTransformPermutations()
{
...
void CML::globalIndexAndTransform::determinePatchTransformSign()
{
    const polyBoundaryMesh& patches = mesh_.boundaryMesh();
...
bool CML::globalIndexAndTransform::uniqueTransform
(
    const point& pt,
...
CML::globalIndexAndTransform::globalIndexAndTransform(const polyMesh& mesh)
:
    mesh_(mesh),
    transforms_(),
