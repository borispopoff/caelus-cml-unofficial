...
template<class Cmpt>
inline CML::SymmTensor2D<Cmpt>::SymmTensor2D()
{}


template<class Cmpt>
inline CML::SymmTensor2D<Cmpt>::SymmTensor2D(const CML::zero)
:
...
template<class Cmpt>
inline CML::SymmTensor2D<Cmpt>::SymmTensor2D(const SphericalTensor2D<Cmpt>& st)
{
...
template<class Cmpt>
inline CML::SymmTensor2D<Cmpt>::SymmTensor2D(Istream& is)
:
...
template<class Cmpt>
inline const Cmpt& CML::SymmTensor2D<Cmpt>::xx() const
{
    return this->v_[XX];
}

template<class Cmpt>
inline const Cmpt& CML::SymmTensor2D<Cmpt>::xy() const
{
    return this->v_[XY];
}

template<class Cmpt>
inline const Cmpt& CML::SymmTensor2D<Cmpt>::yy() const
{
    return this->v_[YY];
}
...
template<class Cmpt>
inline Cmpt& CML::SymmTensor2D<Cmpt>::xx()
{
    return this->v_[XX];
}

template<class Cmpt>
inline Cmpt& CML::SymmTensor2D<Cmpt>::xy()
{
    return this->v_[XY];
}

template<class Cmpt>
inline Cmpt& CML::SymmTensor2D<Cmpt>::yy()
{
    return this->v_[YY];
}
...
template<class Cmpt>
inline const CML::SymmTensor2D<Cmpt>& CML::SymmTensor2D<Cmpt>::T() const
{
    return *this;
}
...
template<class Cmpt>
inline void CML::SymmTensor2D<Cmpt>::operator=
(
