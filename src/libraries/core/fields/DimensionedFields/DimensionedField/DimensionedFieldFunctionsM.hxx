    ...
    (                                                                         \
        ...
        (                                                                     \
            ...
            Dfunc(df1.dimensions())                                           \
                                                                              ...
                                                                              \
    CML::OpFunc(tRes().field(), df1.field());                                 \
                                                                              \
    return tRes;                                                              \
}                                                                             \
                                                                              \
    ...
    (                                                                         \
        ...
        (                                                                     \
            ...
            dt1.dimensions() Op df2.dimensions()                              \
                                                                              ...
                                                                              \
    CML::OpFunc(tRes().field(), dt1.value(), df2.field());                    \
                                                                              \
    return tRes;                                                              \
}                                                                             \
                                                                              \
    ...
    (                                                                         \
        ...
        (                                                                     \
            ...
            dt1.dimensions() Op df2.dimensions()                              \
                                                                              ...
                                                                              \
    CML::OpFunc(tRes().field(), dt1.value(), tdf2().field());                 \
                                                                              \
    reuseTmpDimensionedField<ReturnType, Type2, GeoMesh>::clear(tdf2);        \
                                                                              \
    return tRes;                                                              \
    ...
    (                                                                         \
        ...
        (                                                                     \
            ...
            df1.dimensions() Op dt2.dimensions()                              \
                                                                              ...
                                                                              \
    CML::OpFunc(tRes().field(), df1.field(), dt2.value());                    \
                                                                              \
    return tRes;                                                              \
}                                                                             \
                                                                              \
    ...
    (                                                                         \
        ...
        (                                                                     \
            ...
            df1.dimensions() Op dt2.dimensions()                              \
                                                                              ...
                                                                              \
    CML::OpFunc(tRes().field(), tdf1().field(), dt2.value());                \
                                                                              \
    reuseTmpDimensionedField<ReturnType, Type1, GeoMesh>::clear(tdf1);        \
                                                                              \
    return tRes;                                                              \
