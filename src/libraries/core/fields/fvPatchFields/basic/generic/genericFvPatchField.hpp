...
template<class Type>
CML::genericFvPatchField<Type>::genericFvPatchField
(
    const fvPatch& p,
    const DimensionedField<Type, volMesh>& iF
)
...
template<class Type>
void CML::genericFvPatchField<Type>::autoMap
(
...
template<class Type>
void CML::genericFvPatchField<Type>::rmap
(
