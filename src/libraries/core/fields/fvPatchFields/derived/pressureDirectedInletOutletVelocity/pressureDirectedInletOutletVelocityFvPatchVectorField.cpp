...
#include "pressureDirectedInletOutletVelocityFvPatchVectorField.hpp"
...
void CML::pressureDirectedInletOutletVelocityFvPatchVectorField::autoMap
(
...
void CML::pressureDirectedInletOutletVelocityFvPatchVectorField::rmap
(
...
void CML::pressureDirectedInletOutletVelocityFvPatchVectorField::updateCoeffs()
{
    if (updated())
    {
        return;
...
void CML::pressureDirectedInletOutletVelocityFvPatchVectorField::write
(
    Ostream& os
) const
{
...
void CML::pressureDirectedInletOutletVelocityFvPatchVectorField::operator=
(
