...
Class
    CML::nonuniformTransformCyclicPointPatchField

Description
    Cyclic + slip constraints

SourceFiles
    nonuniformTransformCyclicPointPatchField.cpp
...
#include "nonuniformTransformCyclicPointPatch.hpp"
...
template<class Type>
CML::nonuniformTransformCyclicPointPatchField<Type>::
nonuniformTransformCyclicPointPatchField
(
    const pointPatch& p,
    const DimensionedField<Type, pointMesh>& iF
...
template<class Type>
void CML::nonuniformTransformCyclicPointPatchField<Type>::evaluate
(
