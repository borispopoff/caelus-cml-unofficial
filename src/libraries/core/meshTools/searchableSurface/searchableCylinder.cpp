...
CML::pointIndexHit CML::searchableCylinder::findNearest
(
    const point& sample,
...
CML::scalar CML::searchableCylinder::radius2(const point& pt) const
{
...
void CML::searchableCylinder::findLineAll
(
    const point& start,
    const point& end,
    pointIndexHit& near,
...
CML::boundBox CML::searchableCylinder::calcBounds() const
{
...
CML::searchableCylinder::searchableCylinder
(
    const IOobject& io,
    const point& point1,
    const point& point2,
...
const CML::wordList& CML::searchableCylinder::regions() const
{
    if (regions_.empty())
    {
        regions_.setSize(1);
...
void CML::searchableCylinder::findNearest
(
...
void CML::searchableCylinder::findLine
(
...
void CML::searchableCylinder::findLineAny
(
    const pointField& start,
    const pointField& end,
    List<pointIndexHit>& info
...
void CML::searchableCylinder::getRegion
(
...
void CML::searchableCylinder::getNormal
(
    const List<pointIndexHit>& info,
    vectorField& normal
) const
...
void CML::searchableCylinder::getVolumeType
(
