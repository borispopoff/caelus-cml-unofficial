...
bool CML::searchableSurfaces::connected
(
    const triSurface& s,
    const label edgeI,
...
CML::searchableSurfaces::searchableSurfaces(const label size)
:
...
//CML::searchableSurfaces::searchableSurfaces
//(
//    const IOobject& io,
...
CML::label CML::searchableSurfaces::findSurfaceID
(
...
CML::label CML::searchableSurfaces::findSurfaceRegionID
(
...
void CML::searchableSurfaces::findAnyIntersection
(
...
void CML::searchableSurfaces::findAllIntersections
(
    const pointField& start,
    const pointField& end,
...
void CML::searchableSurfaces::findNearestIntersection
(
    const pointField& start,
    const pointField& end,
    labelList& surface1,
...
void CML::searchableSurfaces::findNearest
(
...
CML::boundBox CML::searchableSurfaces::bounds() const
{
...
CML::pointIndexHit CML::searchableSurfaces::facesIntersection
(
...
bool CML::searchableSurfaces::checkClosed(const bool report) const
{
    if (report)
    {
...
bool CML::searchableSurfaces::checkNormalOrientation(const bool report) const
{
    if (report)
    {
...
bool CML::searchableSurfaces::checkSizes
(
...
bool CML::searchableSurfaces::checkQuality
(
...
CML::label CML::searchableSurfaces::checkTopology
(
    const bool report
) const
{
...
CML::label CML::searchableSurfaces::checkGeometry
(
    const scalar maxRatio,
    const scalar tol,
    const autoPtr<writer<scalar>>& setWriter,
...
void CML::searchableSurfaces::writeStats
(
...
const CML::searchableSurface& CML::searchableSurfaces::operator[]
(
    const word& surfName
) const
{
...
CML::searchableSurface& CML::searchableSurfaces::operator[]
(
    const word& surfName
)
{
