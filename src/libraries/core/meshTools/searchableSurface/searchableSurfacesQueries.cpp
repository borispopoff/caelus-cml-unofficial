...
CML::pointIndexHit CML::searchableSurfacesQueries::tempFindNearest
(
...
CML::scalar CML::searchableSurfacesQueries::sumDistSqr
(
...
//  sum of all points)
CML::scalar CML::searchableSurfacesQueries::tryMorphTet
(
    const PtrList<searchableSurface>& allSurfaces,
    const labelList& surfacesToTest,
    const scalar initDistSqr,
...
bool CML::searchableSurfacesQueries::morphTet
(
    const PtrList<searchableSurface>& allSurfaces,
    const labelList& surfacesToTest,
    const scalar initDistSqr,
...
//void CML::searchableSurfacesQueries::findAllIntersections
//(
...
// surface surfI.
void CML::searchableSurfacesQueries::mergeHits
(
    const point& start,
...
void CML::searchableSurfacesQueries::findAnyIntersection
(
    const PtrList<searchableSurface>& allSurfaces,
    const labelList& surfacesToTest,
    const pointField& start,
...
void CML::searchableSurfacesQueries::findNearestIntersection
(
   const PtrList<searchableSurface>& allSurfaces,
   const labelList& surfacesToTest,
   const pointField& start,
...
void CML::searchableSurfacesQueries::findNearest
(
    const PtrList<searchableSurface>& allSurfaces,
    const labelList& surfacesToTest,
...
void CML::searchableSurfacesQueries::signedDistance
(
    const PtrList<searchableSurface>& allSurfaces,
    const labelList& surfacesToTest,
    const pointField& samples,
...
CML::boundBox CML::searchableSurfacesQueries::bounds
(
    const PtrList<searchableSurface>& allSurfaces,
    const labelList& surfacesToTest
)
...
CML::pointIndexHit CML::searchableSurfacesQueries::facesIntersection
(
    const PtrList<searchableSurface>& allSurfaces,
    const labelList& surfacesToTest,
    const scalar initDistSqr,
...
)
{
    ...
    //{
    //    // Restart
    //    scalar smallDist = CML::sqr(convergenceDistSqr);
