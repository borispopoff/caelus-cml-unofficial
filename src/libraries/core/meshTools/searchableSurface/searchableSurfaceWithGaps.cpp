...
#include "searchableSurfaceWithGaps.hpp"
...
CML::Pair<CML::vector> CML::searchableSurfaceWithGaps::offsetVecs
(
    const point& start,
    const point& end
) const
...
void CML::searchableSurfaceWithGaps::offsetVecs
(
...
CML::label CML::searchableSurfaceWithGaps::countMisses
(
...
CML::searchableSurfaceWithGaps::searchableSurfaceWithGaps
(
    const IOobject& io,
...
void CML::searchableSurfaceWithGaps::findLine
(
    const pointField& start,
    const pointField& end,
...
void CML::searchableSurfaceWithGaps::findLineAny
(
    const pointField& start,
    const pointField& end,
    List<pointIndexHit>& info
...
void CML::searchableSurfaceWithGaps::findLineAll
(
    const pointField& start,
    const pointField& end,
