...
#include "cellQuality.hpp"
#include "unitConversion.hpp"
#include "SubField.hpp"

// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

CML::cellQuality::cellQuality(const polyMesh& mesh)
:
    mesh_(mesh)
{}
...
CML::tmp<CML::scalarField> CML::cellQuality::nonOrthogonality() const
{
...
CML::tmp<CML::scalarField> CML::cellQuality::skewness() const
{
    tmp<scalarField> tresult
    (
        new scalarField
...
CML::tmp<CML::scalarField> CML::cellQuality::faceNonOrthogonality() const
{
    tmp<scalarField> tresult
    (
        new scalarField
...
CML::tmp<CML::scalarField> CML::cellQuality::faceSkewness() const
{
    tmp<scalarField> tresult
    (
        new scalarField
