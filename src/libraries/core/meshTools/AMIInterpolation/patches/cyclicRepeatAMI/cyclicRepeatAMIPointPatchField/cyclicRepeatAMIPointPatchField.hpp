...
Class
    CML::cyclicRepeatAMIPointPatchField

Description
    Repeat AMI front and back plane patch field

SourceFiles
    cyclicRepeatAMIPointPatchField.cpp

\*---------------------------------------------------------------------------*/

#ifndef cyclicRepeatAMIPointPatchField_HPP
#define cyclicRepeatAMIPointPatchField_HPP

#include "cyclicAMIPointPatchField.hpp"
#include "cyclicRepeatAMIPointPatch.hpp"
