...
void CML::cyclicRepeatAMIPolyPatch::resetAMI() const
{
    if (!owner())
    {
        return;
...
CML::cyclicRepeatAMIPolyPatch::cyclicRepeatAMIPolyPatch
(
    const word& name,
    const label size,
    const label start,
...
const CML::cyclicRepeatAMIPolyPatch&
CML::cyclicRepeatAMIPolyPatch::neighbPatch() const
{
...
CML::label CML::cyclicRepeatAMIPolyPatch::transformPatchID() const
{
...
const CML::coupledPolyPatch&
CML::cyclicRepeatAMIPolyPatch::transformPatch() const
{
...
const CML::scalarField& CML::cyclicRepeatAMIPolyPatch::weightsSum() const
{
...
CML::cyclicRepeatAMIPolyPatch::neighbWeightsSum() const
{
    // See above.
