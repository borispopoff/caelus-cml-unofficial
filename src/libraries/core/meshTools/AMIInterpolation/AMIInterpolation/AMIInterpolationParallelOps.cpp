...
CML::label CML::AMIInterpolation::calcDistribution
(
...
CML::label CML::AMIInterpolation::calcOverlappingProcs
(
...
void CML::AMIInterpolation::distributePatches
(
...
void CML::AMIInterpolation::distributeAndMergePatches
(
    const mapDistribute& map,
    const primitivePatch& tgtPatch,
    const globalIndex& gi,
...
CML::AMIInterpolation::calcProcMap
(
    const primitivePatch& srcPatch,
    const primitivePatch& tgtPatch
) const
