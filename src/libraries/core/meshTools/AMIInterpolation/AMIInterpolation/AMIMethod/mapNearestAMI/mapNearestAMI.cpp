...
void CML::mapNearestAMI::findNearestFace
(
...
void CML::mapNearestAMI::setNextNearestFaces
(
    boolList& mapFlag,
    label& startSeedI,
    label& srcFacei,
...
CML::label CML::mapNearestAMI::findMappedSrcFace
(
...
CML::mapNearestAMI::mapNearestAMI
(
    const primitivePatch& srcPatch,
    const primitivePatch& tgtPatch,
...
void CML::mapNearestAMI::calculate
(
