...
const CML::scalar CML::sweptFaceAreaWeightAMI::minCutRatio_ = 10*SMALL;

const CML::scalar CML::sweptFaceAreaWeightAMI::maxDot_ =
    - cos(degToRad(89.9));
...
void CML::sweptFaceAreaWeightAMI::writeCutTrisVTK
(
...
void CML::sweptFaceAreaWeightAMI::writeFaceOBJ
(
    const face& f,
    const pointField& ps,
    const string& name
...
void CML::sweptFaceAreaWeightAMI::writeProjectionOBJ
(
    const label srcN,
...
CML::label CML::sweptFaceAreaWeightAMI::getSourceProjection
(
...
CML::plane CML::sweptFaceAreaWeightAMI::getCutPlane
(
    const point& p0,
    const point& p1,
    const vector& n0,
...
CML::scalar CML::sweptFaceAreaWeightAMI::interArea
(
...
CML::scalar CML::sweptFaceAreaWeightAMI::minWeight() const
{
    return SMALL;
}


CML::scalar CML::sweptFaceAreaWeightAMI::maxWalkAngle() const
{
    return degToRad(180);
}
...
CML::sweptFaceAreaWeightAMI::~sweptFaceAreaWeightAMI()
{}
