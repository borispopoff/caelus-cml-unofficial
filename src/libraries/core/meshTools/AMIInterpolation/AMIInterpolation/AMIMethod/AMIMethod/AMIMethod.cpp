...
void CML::AMIMethod::checkPatches() const
{
...
void CML::AMIMethod::writeIntersectionOBJ
(
    const scalar area,
    const face& f1,
    const face& f2,
...
CML::label CML::AMIMethod::findTargetFace
(
...
void CML::AMIMethod::appendNbrFaces
(
    const label facei,
...
CML::scalar CML::AMIMethod::maxWalkAngle() const
{
    return degToRad(89);
}
...
bool CML::AMIMethod::conformal() const
{
    return true;
}
...
CML::autoPtr<CML::AMIMethod> CML::AMIMethod::New
(
