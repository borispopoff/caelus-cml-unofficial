...
void CML::faceAreaWeightAMI::calcAddressing
(
...
bool CML::faceAreaWeightAMI::processSourceFace
(
...
void CML::faceAreaWeightAMI::setNextFaces
(
    label& startSeedI,
    label& srcFacei,
    label& tgtFacei,
...
CML::scalar CML::faceAreaWeightAMI::interArea
(
    const label srcFacei,
...
void CML::faceAreaWeightAMI::restartUncoveredSourceFace
(
    List<DynamicList<label>>& srcAddr,
    List<DynamicList<scalar>>& srcWght,
    List<DynamicList<label>>& tgtAddr,
...
CML::scalar CML::faceAreaWeightAMI::minWeight() const
{
...
CML::faceAreaWeightAMI::faceAreaWeightAMI
(
...
void CML::faceAreaWeightAMI::calculate
(
