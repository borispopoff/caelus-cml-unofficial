...
void CML::faceAreaIntersect::triSliceWithPlane
(
    const triPoints& tri,
    const plane& p,
...
CML::scalar CML::faceAreaIntersect::triangleIntersect
(
    const triPoints& src,
    const triPoints& tgt,
    const vector& n
...
CML::faceAreaIntersect::faceAreaIntersect
(
...
void CML::faceAreaIntersect::triangulate
(
    const face& f,
