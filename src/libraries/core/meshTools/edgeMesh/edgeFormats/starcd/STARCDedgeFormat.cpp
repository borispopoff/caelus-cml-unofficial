...
inline void CML::fileFormats::STARCDedgeFormat::writeLines
(
    Ostream& os,
...
void CML::fileFormats::STARCDedgeFormat::writeCase
(
    Ostream& os,
...
CML::fileFormats::STARCDedgeFormat::STARCDedgeFormat
(
...
bool CML::fileFormats::STARCDedgeFormat::read
(
    const fileName& filename
)
{
...
void CML::fileFormats::STARCDedgeFormat::write
(
    const fileName& filename,
    const edgeMesh& mesh
)
