...
//bool CML::surfaceSets::usesPoint
//(
//    const primitiveMesh& mesh,
...
//CML::label CML::surfaceSets::removeHangingCells
//(
//    const primitiveMesh& mesh,
...
//// connected edges)
//void CML::surfaceSets::getNearPoints
//(
//    const primitiveMesh& mesh,
//    const triSurface&,
//    const triSurfaceSearch& querySurf,
...
void CML::surfaceSets::getSurfaceSets
(
    const polyMesh& mesh,
    const fileName&,
    const triSurface&,
...
CML::labelHashSet CML::surfaceSets::getHangingCells
(
    const primitiveMesh& mesh,
...
//void CML::surfaceSets::writeSurfaceSets
//(
//    const polyMesh& mesh,
