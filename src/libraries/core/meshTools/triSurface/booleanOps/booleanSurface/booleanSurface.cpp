...
// marked.
void CML::booleanSurface::checkIncluded
(
...
// Linear lookup
CML::label CML::booleanSurface::index
(
...
CML::label CML::booleanSurface::findEdge
(
...
CML::geometricSurfacePatchList CML::booleanSurface::mergePatches
(
...
void CML::booleanSurface::propagateEdgeSide
(
...
void CML::booleanSurface::propagateSide
(
    const triSurface& surf,
    const label prevState,
    const label facei,
...
// Null constructor
CML::booleanSurface::booleanSurface()
:
    triSurface()
{}
