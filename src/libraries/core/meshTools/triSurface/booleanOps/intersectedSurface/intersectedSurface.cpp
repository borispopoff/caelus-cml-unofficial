...
#include "intersectedSurface.hpp"
...
void CML::intersectedSurface::writeOBJ
(
...
void CML::intersectedSurface::writeLocalOBJ
(
    const pointField& points,
    const edgeList& edges,
    const labelList& faceEdges,
...
void CML::intersectedSurface::printVisit
(
    const edgeList& edges,
...
// both faces.
bool CML::intersectedSurface::sameEdgeOrder
(
...
void CML::intersectedSurface::incCount
(
    Map<label>& visited,
    const label key,
    const label offset
...
CML::label CML::intersectedSurface::nextEdge
(
    const edgeSurface& eSurf,
    const Map<label>& visited,
    const label facei,
...
// Null constructor
CML::intersectedSurface::intersectedSurface()
:
    triSurface(),
...
CML::intersectedSurface::intersectedSurface(const triSurface& surf)
:
    triSurface(surf),
    intersectionEdges_(0),
    faceMap_(0),
