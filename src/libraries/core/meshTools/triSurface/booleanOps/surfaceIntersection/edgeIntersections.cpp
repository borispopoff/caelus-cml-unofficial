...
void CML::edgeIntersections::checkEdges(const triSurface& surf)
{
...
void CML::edgeIntersections::intersectEdges
(
...
bool CML::edgeIntersections::inlinePerturb
(
    const triSurface& surf1,
    const scalarField& surf1PointTol,   // surf1 tolerance per point
    const label edgeI,
...
bool CML::edgeIntersections::rotatePerturb
(
    const triSurface& surf1,
    const scalarField& surf1PointTol,   // surf1 tolerance per point
    const label edgeI,
...
bool CML::edgeIntersections::offsetPerturb
(
    const triSurface& surf1,
...
CML::scalarField CML::edgeIntersections::minEdgeLength(const triSurface& surf)
{
    const pointField& localPoints = surf.localPoints();
...
CML::label CML::edgeIntersections::removeDegenerates
(
    const label nIters,
    const triSurface& surf1,
    const triSurfaceSearch& query2,
