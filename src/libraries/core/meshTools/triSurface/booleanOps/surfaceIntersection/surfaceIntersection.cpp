...
bool CML::surfaceIntersection::excludeEdgeHit
(
...
//// - edgeI
//// - intersection point
//CML::pointIndexHit CML::surfaceIntersection::faceEdgeIntersection
//(
//    const triSurface& surf,
...
void CML::surfaceIntersection::storeIntersection
(
...
// surface2 reversed.
void CML::surfaceIntersection::classifyHit
(
...
//
void CML::surfaceIntersection::doCutEdges
(
    const triSurface& surf1,
...
// Null constructor
CML::surfaceIntersection::surfaceIntersection()
:
    cutPoints_(0),
    cutEdges_(0),
    facePairToVertex_(0),
...
const CML::pointField& CML::surfaceIntersection::cutPoints() const
{
    return cutPoints_;
}


const CML::edgeList& CML::surfaceIntersection::cutEdges() const
{
    return cutEdges_;
}


const CML::labelPairLookup& CML::surfaceIntersection::facePairToEdge() const
{
    return facePairToEdge_;
}


const CML::labelListList& CML::surfaceIntersection::edgeCuts
(
    const bool isFirstSurf
) const
{
...
const CML::labelListList& CML::surfaceIntersection::surf1EdgeCuts() const
{
    return surf1EdgeCuts_;
}


const CML::labelListList& CML::surfaceIntersection::surf2EdgeCuts() const
{
    return surf2EdgeCuts_;
}
