...
bool CML::orientedSurface::consistentEdge
(
    const edge& e,
...
CML::labelList CML::orientedSurface::faceToEdge
(
    const triSurface& s,
...
CML::labelList CML::orientedSurface::edgeToFace
(
    const triSurface& s,
...
void CML::orientedSurface::propagateOrientation
(
    const triSurface& s,
...
void CML::orientedSurface::findZoneSide
(
...
bool CML::orientedSurface::flipSurface
(
    triSurface& s,
...
bool CML::orientedSurface::orientConsistent(triSurface& s)
{
...
// Null constructor
CML::orientedSurface::orientedSurface()
:
    triSurface()
{}
...
bool CML::orientedSurface::orient
(
    triSurface& s,
    const point& samplePoint,
    const bool orientOutside
