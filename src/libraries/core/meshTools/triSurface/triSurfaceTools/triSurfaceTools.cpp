...
const CML::label CML::triSurfaceTools::ANYEDGE = -1;
const CML::label CML::triSurfaceTools::NOEDGE = -2;
const CML::label CML::triSurfaceTools::COLLAPSED = -3;
...
CML::triSurface CML::triSurfaceTools::doRefine
(
    const triSurface& surf,
...
CML::scalar CML::triSurfaceTools::faceCosAngle
(
    const point& pStart,
    const point& pEnd,
    const point& pLeft,
...
void CML::triSurfaceTools::protectNeighbours
(
    const triSurface& surf,
    const label vertI,
...
CML::labelHashSet CML::triSurfaceTools::getCollapsedFaces
(
    const triSurface& surf,
    label edgeI
)
...
CML::label CML::triSurfaceTools::vertexUsesFace
(
    const triSurface& surf,
...
void CML::triSurfaceTools::getMergedEdges
(
    const triSurface& surf,
    const label edgeI,
...
//  edge to v1 at pt.
CML::scalar CML::triSurfaceTools::collapseMinCosAngle
(
    const triSurface& surf,
    const label v1,
    const point& pt,
...
bool CML::triSurfaceTools::collapseCreatesFold
(
    const triSurface& surf,
    const label v1,
    const point& pt,
...
// a vertex.
//bool CML::triSurfaceTools::collapseCreatesDuplicates
//(
//    const triSurface& surf,
//    const label edgeI,
//    const labelHashSet& collapsedFaces
...
//  - miss()
CML::surfaceLocation CML::triSurfaceTools::cutEdge
(
    const triSurface& s,
    const label triI,
...
void CML::triSurfaceTools::snapToEnd
(
    const triSurface& s,
...
//  - triangle to exclude
CML::surfaceLocation CML::triSurfaceTools::visitFaces
(
    const triSurface& s,
...
)
{
    ...
    scalar minDistSqr = CML::sqr(GREAT);
...
void CML::triSurfaceTools::writeOBJ
(
...
void CML::triSurfaceTools::getVertexTriangles
(
    const triSurface& surf,
    const label edgeI,
    labelList& edgeTris
...
CML::labelList CML::triSurfaceTools::getVertexVertices
(
    const triSurface& surf,
    const edge& e
)
...
//void CML::triSurfaceTools::orderVertices
//(
//    const labelledTri& f,
//    const label v1,
//    const label v2,
...
CML::label CML::triSurfaceTools::getEdge
(
    const triSurface& surf,
    const label v1,
    const label v2
...
CML::label CML::triSurfaceTools::getTriangle
(
    const triSurface& surf,
    const label e0I,
    const label e1I,
...
CML::triSurface CML::triSurfaceTools::collapseEdges
(
    const triSurface& surf,
...
CML::triSurface CML::triSurfaceTools::redGreenRefine
(
    const triSurface& surf,
...
CML::triSurface CML::triSurfaceTools::greenRefine
(
    const triSurface& surf,
...
CML::label CML::triSurfaceTools::minEdge
(
    const triSurface& surf,
...
CML::label CML::triSurfaceTools::maxEdge
(
    const triSurface& surf,
    const labelList& edgeIndices
)
...
CML::triSurface CML::triSurfaceTools::mergePoints
(
    const triSurface& surf,
...
CML::vector CML::triSurfaceTools::surfaceNormal
(
    const triSurface& surf,
...
CML::triSurfaceTools::sideType CML::triSurfaceTools::edgeSide
(
    const triSurface& surf,
    const point& sample,
...
// Calculate normal on triangle
CML::triSurfaceTools::sideType CML::triSurfaceTools::surfaceSide
(
    const triSurface& surf,
    const point& sample,
    const label nearestFaceI
    ...
    else
    {
        ...
        forAll(pEdges, i)
        {
            ...
            if (magEVec > VSMALL)
            {
                ...
                scalar distSqr = CML::magSqr(sample - perturbPoint);
...
CML::triSurface CML::triSurfaceTools::triangulate
(
...
// triangulation of boundaryMesh
CML::triSurface CML::triSurfaceTools::triangulateFaceCentre
(
    const polyBoundaryMesh& bMesh,
    const labelHashSet& includePatches,
    const bool verbose
...
CML::triSurface CML::triSurfaceTools::delaunay2D(const List<vector2D>& pts)
{
...
void CML::triSurfaceTools::calcInterpolationWeights
(
...
CML::surfaceLocation CML::triSurfaceTools::classify
(
    const triSurface& s,
    const label triI,
...
CML::surfaceLocation CML::triSurfaceTools::trackToEdge
(
    const triSurface& s,
    const surfaceLocation& start,
    const surfaceLocation& end,
...
void CML::triSurfaceTools::track
(
    const triSurface& s,
