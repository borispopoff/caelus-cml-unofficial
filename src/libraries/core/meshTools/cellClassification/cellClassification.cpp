...
CML::label CML::cellClassification::count
(
...
// faces are pierced.
CML::boolList CML::cellClassification::markFaces
(
...
// 'outside'
void CML::cellClassification::markCells
(
...
void CML::cellClassification::classifyPoints
(
...
void CML::cellClassification::getMeshOutside
(
    const label meshType,
...
CML::cellClassification::cellClassification
(
    const polyMesh& mesh,
...
// Construct as copy
CML::cellClassification::cellClassification(const cellClassification& cType)
:
    labelList(cType),
    mesh_(cType.mesh())
{}
...
CML::label CML::cellClassification::trimCutCells
(
    const label nLayers,
    const label meshType,
...
CML::label CML::cellClassification::growSurface
(
    const label meshType,
    const label fillType
)
...
// onto the surface.
CML::label CML::cellClassification::fillHangingCells
(
    const label meshType,
    const label fillType,
    const label maxIter
...
CML::label CML::cellClassification::fillRegionEdges
(
    const label meshType,
    const label fillType,
    const label maxIter
...
CML::label CML::cellClassification::fillRegionPoints
(
    const label meshType,
    const label fillType,
    const label maxIter
...
void CML::cellClassification::writeStats(Ostream& os) const
{
    os  << "Cells:" << size() << endl
...
void CML::cellClassification::operator=(const CML::cellClassification& rhs)
{
