...
// but is not edgeI
CML::label CML::cellFeatures::nextEdge
(
...
bool CML::cellFeatures::isCellFeatureEdge
(
    const scalar minCos,
    const label edgeI
) const
...
void CML::cellFeatures::calcSuperFaces() const
{
...
bool CML::cellFeatures::isFeaturePoint(const label edge0, const label edge1)
 const
{
    if
    (
