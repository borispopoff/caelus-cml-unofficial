...
void CML::momentOfInertia::massPropertiesSolid
(
...
void CML::momentOfInertia::massPropertiesShell
(
    const pointField& pts,
    const triFaceList& triFaces,
    scalar density,
...
CML::tensor CML::momentOfInertia::applyParallelAxisTheorem
(
    scalar mass,
    const vector& cM,
    const tensor& J,
...
CML::tmp<CML::tensorField> CML::momentOfInertia::meshInertia
(
    const polyMesh& mesh
)
{
