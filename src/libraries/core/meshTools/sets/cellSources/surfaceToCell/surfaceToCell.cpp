...
CML::topoSetSource::addToUsageTable CML::surfaceToCell::usage_
(
...
bool CML::surfaceToCell::differingPointNormals
(
    const triSurfaceSearch& querySurf,
...
void CML::surfaceToCell::combine(topoSet& set, const bool add) const
{
    cpuTime timer;
...
void CML::surfaceToCell::checkSettings() const
{
    if
    (
        (nearDist_ < 0)
...
CML::surfaceToCell::surfaceToCell
(
    const polyMesh& mesh,
...
void CML::surfaceToCell::applyToSet
(
