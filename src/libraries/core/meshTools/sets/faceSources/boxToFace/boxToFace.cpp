...
CML::topoSetSource::addToUsageTable CML::boxToFace::usage_
(
    boxToFace::typeName,
...
void CML::boxToFace::combine(topoSet& set, const bool add) const
{
