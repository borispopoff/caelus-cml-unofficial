...
void CML::regionSplit::calcNonCompactRegionSplit
(
...
CML::autoPtr<CML::globalIndex> CML::regionSplit::calcRegionSplit
(
...
CML::regionSplit::regionSplit(const polyMesh& mesh, const bool doGlobalRegions)
:
