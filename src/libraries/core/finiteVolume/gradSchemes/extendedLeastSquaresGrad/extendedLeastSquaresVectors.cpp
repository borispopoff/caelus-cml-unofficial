...
CML::extendedLeastSquaresVectors::extendedLeastSquaresVectors
(
    const fvMesh& mesh,
    const scalar minDet
)
...
void CML::extendedLeastSquaresVectors::makeLeastSquaresVectors() const
{
    if (debug)
    {
...
CML::extendedLeastSquaresVectors::pVectors() const
{
    if (!pVectorsPtr_)
    {
...
const CML::surfaceVectorField&
CML::extendedLeastSquaresVectors::nVectors() const
{
    if (!nVectorsPtr_)
    {
        makeLeastSquaresVectors();
...
CML::extendedLeastSquaresVectors::additionalCells() const
{
...
const CML::vectorField&
CML::extendedLeastSquaresVectors::additionalVectors() const
{
...
bool CML::extendedLeastSquaresVectors::movePoints()
{
    deleteDemandDrivenData(pVectorsPtr_);
    deleteDemandDrivenData(nVectorsPtr_);
