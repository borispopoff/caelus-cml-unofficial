...
#include "faceMDLimitedGrad.hpp"
#include "cellMDLimitedGrad.hpp"
...
CML::fv::faceMDLimitedGrad<CML::scalar>::calcGrad
(
...
template<>
CML::tmp<CML::volTensorField>
CML::fv::faceMDLimitedGrad<CML::vector>::calcGrad
(
