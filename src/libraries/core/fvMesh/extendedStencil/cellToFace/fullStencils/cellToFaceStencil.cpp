...
void CML::cellToFaceStencil::merge
(
    const label global0,
    const label global1,
...
void CML::cellToFaceStencil::validBoundaryFaces(boolList& isValidBFace) const
{
...
CML::cellToFaceStencil::allCoupledFacesPatch() const
{
    const polyBoundaryMesh& patches = mesh().boundaryMesh();
...
void CML::cellToFaceStencil::unionEqOp::operator()
(
    labelList& x,
    const labelList& y
) const
...
void CML::cellToFaceStencil::insertFaceCells
(
...
CML::labelList CML::cellToFaceStencil::calcFaceCells
(
    const boolList& isValidBFace,
    const labelList& faceLabels,
    labelHashSet& globals
...
void CML::cellToFaceStencil::calcFaceStencil
(
...
CML::cellToFaceStencil::cellToFaceStencil(const polyMesh& mesh)
:
    mesh_(mesh),
