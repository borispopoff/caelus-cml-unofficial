...
void CML::FECCellToFaceStencil::calcEdgeBoundaryData
(
...
// numbering).
void CML::FECCellToFaceStencil::calcFaceStencil
(
...
CML::FECCellToFaceStencil::FECCellToFaceStencil(const polyMesh& mesh)
:
