...
void CML::extendedUpwindCellToFaceStencil::selectOppositeFaces
(
...
void CML::extendedUpwindCellToFaceStencil::transportStencil
(
    const boolList& nonEmptyFace,
...
void CML::extendedUpwindCellToFaceStencil::transportStencils
(
    const labelListList& faceStencil,
    const scalar minOpposedness,
...
CML::extendedUpwindCellToFaceStencil::extendedUpwindCellToFaceStencil
(
