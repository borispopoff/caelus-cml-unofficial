...
void CML::cellToCellStencil::merge
(
    const label global0,
    const label global1,
...
void CML::cellToCellStencil::validBoundaryFaces(boolList& isValidBFace) const
{
...
CML::cellToCellStencil::allCoupledFacesPatch() const
{
    const polyBoundaryMesh& patches = mesh().boundaryMesh();
...
void CML::cellToCellStencil::unionEqOp::operator()
(
    labelList& x,
    const labelList& y
) const
...
void CML::cellToCellStencil::insertFaceCells
(
...
CML::labelList CML::cellToCellStencil::calcFaceCells
(
    const boolList& isValidBFace,
    const labelList& faceLabels,
    labelHashSet& globals
...
CML::cellToCellStencil::cellToCellStencil(const polyMesh& mesh)
:
    mesh_(mesh),
