...
void CML::simpleControl::read()
{
    solutionControl::read(true);
}


bool CML::simpleControl::criteriaSatisfied()
{
...
CML::simpleControl::simpleControl(fvMesh& mesh)
:
...
CML::simpleControl::~simpleControl()
{}


// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //

bool CML::simpleControl::loop()
{
    read();
