...
Class
    CML::limitedCentralDL

Description
    LimitedCentralDL scheme class.

SourceFiles
    limitedCentralDL.cpp
...
#ifndef limitedCentralDL_HPP
#define limitedCentralDL_HPP
...
template<class Type>
class limitedCentralDL : public upwind<Type>
{
    ...
    limitedCentralDL(limitedCentralDL const&);

    //- Disallow default bitwise assignment
    void operator=(limitedCentralDL const&);

public:

    //- Runtime type information
    TypeName("limitedCentralDL");
