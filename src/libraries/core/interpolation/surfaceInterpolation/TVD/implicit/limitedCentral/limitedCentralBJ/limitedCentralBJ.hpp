...
Class
    CML::limitedCentralBJ

Description
    LimitedCentralBJ scheme class.

SourceFiles
    limitedCentralBJ.cpp
...
#ifndef limitedCentralBJ_HPP
#define limitedCentralBJ_HPP
...
template<class Type>
class limitedCentralBJ : public upwind<Type>
{
    ...
    limitedCentralBJ(limitedCentralBJ const&);

    //- Disallow default bitwise assignment
    void operator=(limitedCentralBJ const&);

public:

    //- Runtime type information
    TypeName("limitedCentralBJ");
