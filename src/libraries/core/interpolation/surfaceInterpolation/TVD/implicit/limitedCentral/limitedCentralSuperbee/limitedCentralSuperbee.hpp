...
Class
    CML::limitedCentralSuperbee

Description
    LimitedCentralSuperbee scheme class.

SourceFiles
    limitedCentralSuperbee.cpp
...
#ifndef limitedCentralSuperbee_HPP
#define limitedCentralSuperbee_HPP
...
template<class Type>
class limitedCentralSuperbee : public upwind<Type>
{
    ...
    limitedCentralSuperbee(limitedCentralSuperbee const&);

    //- Disallow default bitwise assignment
    void operator=(limitedCentralSuperbee const&);

public:

    //- Runtime type information
    TypeName("limitedCentralSuperbee");

    // Constructors

    //- Construct from faceFlux
    limitedCentralSuperbee
    (
        fvMesh const& mesh,
