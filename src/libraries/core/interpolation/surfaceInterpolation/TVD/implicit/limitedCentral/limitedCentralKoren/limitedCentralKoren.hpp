...
#ifndef limitedCentralKoren_HPP
#define limitedCentralKoren_HPP
...
template<class Type>
class limitedCentralKoren : public upwind<Type>
{
    ...
    limitedCentralKoren(limitedCentralKoren const&);

    //- Disallow default bitwise assignment
    void operator=(limitedCentralKoren const&);

public:

    //- Runtime type information
    TypeName("limitedCentralKoren");
