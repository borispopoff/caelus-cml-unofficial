...
Class
    CML::limitedCentralMinmod

Description
    LimitedCentralMinmod scheme class.

SourceFiles
    limitedCentralMinmod.cpp
...
#ifndef limitedCentralMinmod_HPP
#define limitedCentralMinmod_HPP
...
template<class Type>
class limitedCentralMinmod : public upwind<Type>
{
    ...
    limitedCentralMinmod(limitedCentralMinmod const&);

    //- Disallow default bitwise assignment
    void operator=(limitedCentralMinmod const&);

public:

    //- Runtime type information
    TypeName("limitedCentralMinmod");

    // Constructors

    //- Construct from faceFlux
    limitedCentralMinmod
    (
        fvMesh const& mesh,
