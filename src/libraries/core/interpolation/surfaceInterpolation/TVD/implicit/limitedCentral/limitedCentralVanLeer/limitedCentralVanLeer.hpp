...
Class
    CML::limitedCentralVanLeer

Description
    LimitedCentralVanLeer scheme class.

SourceFiles
    limitedCentralVanLeer.cpp
...
#ifndef limitedCentralVanLeer_HPP
#define limitedCentralVanLeer_HPP
...
template<class Type>
class limitedCentralVanLeer : public upwind<Type>
{
    ...
    limitedCentralVanLeer(limitedCentralVanLeer const&);

    //- Disallow default bitwise assignment
    void operator=(limitedCentralVanLeer const&);

public:

    //- Runtime type information
    TypeName("limitedCentralVanLeer");

    // Constructors

    //- Construct from faceFlux
    limitedCentralVanLeer
    (
        fvMesh const& mesh,
