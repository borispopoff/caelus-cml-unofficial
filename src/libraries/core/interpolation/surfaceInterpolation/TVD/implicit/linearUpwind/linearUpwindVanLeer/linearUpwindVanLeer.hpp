...
#ifndef linearUpwindVanLeer_H
#define linearUpwindVanLeer_H
...
template<class Type>
class linearUpwindVanLeer : public upwind<Type>
{
    ...
    linearUpwindVanLeer(linearUpwindVanLeer const&);

    //- Disallow default bitwise assignment
    void operator=(linearUpwindVanLeer const&);

public:

    //- Runtime type information
    TypeName("linearUpwindVanLeer");
