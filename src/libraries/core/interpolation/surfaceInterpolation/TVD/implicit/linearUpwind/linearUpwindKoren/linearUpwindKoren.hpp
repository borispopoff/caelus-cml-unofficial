...
#ifndef linearUpwindKoren_H
#define linearUpwindKoren_H
...
template<class Type>
class linearUpwindKoren : public upwind<Type>
{
    ...
    linearUpwindKoren(linearUpwindKoren const&);

    //- Disallow default bitwise assignment
    void operator=(linearUpwindKoren const&);

public:

    //- Runtime type information
    TypeName("linearUpwindKoren");
