...
#ifndef linearUpwindSuperbee_H
#define linearUpwindSuperbee_H
...
template<class Type>
class linearUpwindSuperbee : public upwind<Type>
{
    ...
    linearUpwindSuperbee(linearUpwindSuperbee const&);

    //- Disallow default bitwise assignment
    void operator=(linearUpwindSuperbee const&);

public:

    //- Runtime type information
    TypeName("linearUpwindSuperbee");

    //- Construct from faceFlux
    linearUpwindSuperbee
    (
        fvMesh const& mesh,
