...
#ifndef linearUpwindMinmod_H
#define linearUpwindMinmod_H
...
template<class Type>
class linearUpwindMinmod : public upwind<Type>
{
    ...
    linearUpwindMinmod(linearUpwindMinmod const&);

    //- Disallow default bitwise assignment
    void operator=(linearUpwindMinmod const&);

public:

    //- Runtime type information
    TypeName("linearUpwindMinmod");
