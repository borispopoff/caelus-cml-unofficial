...
#ifndef linearUpwindUMIST_H
#define linearUpwindUMIST_H
...
template<class Type>
class linearUpwindUMIST : public upwind<Type>
{
    ...
    linearUpwindUMIST(linearUpwindUMIST const&);

    //- Disallow default bitwise assignment
    void operator=(linearUpwindUMIST const&);

public:

    //- Runtime type information
    TypeName("linearUpwindUMIST");
