...
#ifndef linearUpwindOSPRE_H
#define linearUpwindOSPRE_H
...
class linearUpwindOSPRE : public upwind<Type>
{
    ...
    linearUpwindOSPRE(linearUpwindOSPRE const&);

    //- Disallow default bitwise assignment
    void operator=(linearUpwindOSPRE const&);

public:

    //- Runtime type information
    TypeName("linearUpwindOSPRE");
