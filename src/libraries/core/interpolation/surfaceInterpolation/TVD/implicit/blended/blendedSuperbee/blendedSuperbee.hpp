...
#ifndef blendedSuperbee_HPP
#define blendedSuperbee_HPP
...
template<class Type>
class blendedSuperbee : public upwind<Type>
{
    ...
    blendedSuperbee(blendedSuperbee const&);

    //- Disallow default bitwise assignment
    void operator=(blendedSuperbee const&);

public:

    //- Runtime type information
    TypeName("blendedSuperbee");
