...
Class
    CML::blendedVanAlbada

Description
    blendedVanAlbada scheme class.

SourceFiles
    blendedVanAlbada.cpp
...
#ifndef blendedVanAlbada_HPP
#define blendedVanAlbada_HPP
...
template<class Type>
class blendedVanAlbada : public upwind<Type>
{
    ...
    blendedVanAlbada(blendedVanAlbada const&);

    //- Disallow default bitwise assignment
    void operator=(blendedVanAlbada const&);

public:

    //- Runtime type information
    TypeName("blendedVanAlbada");
