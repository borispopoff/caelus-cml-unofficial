...
Description
    blendedBJ scheme correction function.

Author
    Aleksandar Jemcov

\*---------------------------------------------------------------------------*/
#ifndef blendedCorrection_HPP_
#define blendedCorrection_HPP_
...
{                                                                              \
    ...
    (                                                                          \
        ...
        (                                                                      \
            IOobject                                                           \
            (                                                                  \
                "blended##limiterType##::correction(" + vf.name() + ')',       \
                mesh.time().timeName(),                                        \
                mesh,                                                          \
                IOobject::NO_READ,                                             \
                IOobject::NO_WRITE,                                            \
            ...
            {                                                                  \
                ...
                {                                                              \
                    ...
                    pSfCorr[facei] +=                                          \
                      ...
                      & pGradVfNei[facei];                                     \
                                                                               \
                    pSfCorr[facei] = beta_*pSfCorr[facei] + (1-beta_)*pCorr1;  \
                }                                                              \
                else                                                           \
                {                                                              \
                    r = (scalar(2.0)                                           \
