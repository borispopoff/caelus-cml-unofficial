...
\*---------------------------------------------------------------------------*/
#ifndef linearUpwindCorrection_HPP_
#define linearUpwindCorrection_HPP_
...
{                                                                              \
    ...
    (                                                                          \
        ...
        (                                                                      \
            IOobject                                                           \
            (                                                                  \
                "linearUpwind##limiterType##::correction(" + vf.name() + ')',  \
                mesh.time().timeName(),                                        \
                mesh,                                                          \
                IOobject::NO_READ,                                             \
                IOobject::NO_WRITE,                                            \
    ...
    {                                                                          \
        ...
        scalar const limiter = slopeLimiter(r);                                \
                                                                               \
        sfCorr[facei] =                                                        \
            order_*limiter*(Cf[facei] - C[cellC]) & gradVf[cellC];             \
    }                                                                          \
                                                                               \
            ...
            {                                                                  \
                ...
                {                                                              \
                    ...
                    limiter = slopeLimiter(r);                                 \
                                                                               \
                    pSfCorr[facei] = order_*limiter*(pCf[facei] - C[pown])     \
                                   & gradVf[pown];                             \
                }                                                              \
                else                                                           \
                {                                                              \
