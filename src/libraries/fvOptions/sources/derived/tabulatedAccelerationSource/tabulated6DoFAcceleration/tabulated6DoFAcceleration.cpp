...
CML::tabulated6DoFAcceleration::tabulated6DoFAcceleration
(
...
CML::tabulated6DoFAcceleration::accelerationVectors
CML::tabulated6DoFAcceleration::acceleration() const
{
...
bool CML::tabulated6DoFAcceleration::read
(
    const dictionary& accelerationCoeffs
)
{
