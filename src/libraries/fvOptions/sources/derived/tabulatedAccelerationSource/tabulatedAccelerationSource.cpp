...
#include "tabulatedAccelerationSource.hpp"
#include "fvMesh.hpp"
...
CML::fv::tabulatedAccelerationSource::tabulatedAccelerationSource
(
    const word& name,
...
bool CML::fv::tabulatedAccelerationSource::read(const dictionary& dict)
{
    if (option::read(dict))
    {
