...
void CML::fv::cellSetOption::setSelection(const dictionary& dict)
{
...
void CML::fv::cellSetOption::setCellSet()
{
    switch (selectionMode_)
    {
        case smPoints:
...
CML::fv::cellSetOption::cellSetOption
(
    const word& name,
...
bool CML::fv::cellSetOption::isActive()
{
