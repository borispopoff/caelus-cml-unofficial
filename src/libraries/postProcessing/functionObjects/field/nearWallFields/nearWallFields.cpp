...
void CML::nearWallFields::calcAddressing()
{
...
CML::nearWallFields::nearWallFields
(
    const word& name,
...
void CML::nearWallFields::read(const dictionary& dict)
{
    if (debug)
    {
...
void CML::nearWallFields::execute()
{
    if (debug)
    {
...
void CML::nearWallFields::timeSet()
{
    // Do nothing
}


void CML::nearWallFields::write()
{
    if (debug)
    {
