...
Class
    CML::chemistryTabulationMethods::ISAT
...
template<class CompType, class ThermoType>
CML::chemistryTabulationMethods::ISAT<CompType, ThermoType>::ISAT
(
    const dictionary& chemistryProperties,
    TDACChemistryModel<CompType, ThermoType>& chemistry
)
...
template<class CompType, class ThermoType>
void CML::chemistryTabulationMethods::ISAT<CompType, ThermoType>::addToMRU
(
    chemPointISAT<CompType, ThermoType>* phi0
)
{
...
template<class CompType, class ThermoType>
void CML::chemistryTabulationMethods::ISAT<CompType, ThermoType>::calcNewC
(
    chemPointISAT<CompType, ThermoType>* phi0,
    const scalarField& phiq,
    scalarField& Rphiq
...
template<class CompType, class ThermoType>
bool CML::chemistryTabulationMethods::ISAT<CompType, ThermoType>::grow
(
    chemPointISAT<CompType, ThermoType>* phi0,
    const scalarField& phiq,
    const scalarField& Rphiq
...
template<class CompType, class ThermoType>
bool
CML::chemistryTabulationMethods::ISAT<CompType, ThermoType>::cleanAndBalance()
{
...
template<class CompType, class ThermoType>
void CML::chemistryTabulationMethods::ISAT<CompType, ThermoType>::computeA
(
    scalarSquareMatrix& A,
    const scalarField& Rphiq,
    const scalar rhoi,
...
template<class CompType, class ThermoType>
bool CML::chemistryTabulationMethods::ISAT<CompType, ThermoType>::retrieve
(
    const CML::scalarField& phiq,
    scalarField& Rphiq
)
...
template<class CompType, class ThermoType>
CML::label CML::chemistryTabulationMethods::ISAT<CompType, ThermoType>::add
(
    const scalarField& phiq,
    const scalarField& Rphiq,
    const scalar rho,
...
template<class CompType, class ThermoType>
void
CML::chemistryTabulationMethods::ISAT<CompType, ThermoType>::writePerformance()
{
    if (this->log())
    {
        nRetrievedFile_()
