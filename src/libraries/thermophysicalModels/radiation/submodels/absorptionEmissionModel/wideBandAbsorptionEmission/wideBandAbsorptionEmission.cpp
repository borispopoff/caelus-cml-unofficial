...
CML::radiation::wideBandAbsorptionEmission::wideBandAbsorptionEmission
(
...
CML::radiation::wideBandAbsorptionEmission::aCont(const label bandi) const
{
...
CML::tmp<CML::volScalarField>
CML::radiation::wideBandAbsorptionEmission::eCont(const label bandi) const
{
    return aCont(bandi);
}
