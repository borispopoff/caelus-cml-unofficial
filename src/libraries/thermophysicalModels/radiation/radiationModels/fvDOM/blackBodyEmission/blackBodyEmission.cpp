...
CML::radiation::blackBodyEmission::blackBodyEmission
(
    const label nLambda,
...
CML::scalar CML::radiation::blackBodyEmission::fLambdaT
(
...
CML::radiation::blackBodyEmission::deltaLambdaT
(
    const volScalarField& T,
...
CML::tmp<CML::volScalarField>
CML::radiation::blackBodyEmission::EbDeltaLambdaT
(
    const volScalarField& T,
    const Vector2D<scalar>& band
) const
...
void CML::radiation::blackBodyEmission::correct
(
    const label lambdaI,
    const Vector2D<scalar>& band
)
