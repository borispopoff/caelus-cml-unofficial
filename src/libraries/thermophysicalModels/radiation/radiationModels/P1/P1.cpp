...
CML::radiation::P1::P1(const volScalarField& T)
:
...
void CML::radiation::P1::calculate()
{
...
CML::tmp<CML::volScalarField> CML::radiation::P1::Rp() const
{
