...
Class
    CML::energyJumpAMIFvPatchScalarField
...
SourceFiles
    energyJumpAMIFvPatchScalarField.cpp

\*---------------------------------------------------------------------------*/

#ifndef energyJumpAMIFvPatchScalarField_HPP
#define energyJumpAMIFvPatchScalarField_HPP
