...
Class
    CML::compressible::alphatJayatillekeWallFunctionFvPatchScalarField
...
#ifndef compAlphatJayaWallFunctionFvPatchScalarField_H
#define compAlphatJayaWallFunctionFvPatchScalarField_H
