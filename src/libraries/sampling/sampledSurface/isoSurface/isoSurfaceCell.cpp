...
CML::scalar CML::isoSurfaceCell::isoFraction
(
    const scalar s0,
    const scalar s1
) const
...
bool CML::isoSurfaceCell::isTriCut
(
    const triFace& tri,
...
CML::isoSurfaceCell::cellCutType CML::isoSurfaceCell::calcCutType
(
...
void CML::isoSurfaceCell::calcCutTypes
(
    const PackedBoolList& isTet,
...
CML::labelPair CML::isoSurfaceCell::findCommonPoints
(
...
void CML::isoSurfaceCell::calcSnappedCc
(
    const PackedBoolList& isTet,
    const scalarField& cVals,
    const scalarField& pVals,
...
void CML::isoSurfaceCell::calcSnappedPoint
(
    const PackedBoolList& isTet,
    const scalarField& cVals,
    const scalarField& pVals,
...
CML::triSurface CML::isoSurfaceCell::stitchTriPoints
(
...
CML::triSurface CML::isoSurfaceCell::subsetMesh
(
    const triSurface& s,
...
CML::isoSurfaceCell::isoSurfaceCell
(
    const polyMesh& mesh,
    const scalarField& cVals,
    const scalarField& pVals,
