...
void CML::dxSurfaceWriter::writeGeometry
(
    Ostream& os,
...
void CML::dxSurfaceWriter::writeTrailer(Ostream& os, const bool isNodeValues)
{
    if (isNodeValues)
    {
...
{
    template<>
    void CML::dxSurfaceWriter::writeData
    (
        Ostream& os,
    ...
    template<>
    inline void CML::dxSurfaceWriter::writeData
    (
        Ostream& os,
...
template<class Type>
void CML::dxSurfaceWriter::writeTemplate
(
...
CML::dxSurfaceWriter::dxSurfaceWriter()
:
    surfaceWriter()
{}
...
defineSurfaceWriterWriteFields(CML::dxSurfaceWriter);
