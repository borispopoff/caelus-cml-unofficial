...
#include "nastranSurfaceWriter.hpp"
#include "IOmanip.hpp"
#include "Tuple2.hpp"
...
void CML::nastranSurfaceWriter::formatOS(OFstream& os) const
{
...
void CML::nastranSurfaceWriter::writeGeometry
(
...
CML::nastranSurfaceWriter::nastranSurfaceWriter()
:
    surfaceWriter(),
...
CML::nastranSurfaceWriter::nastranSurfaceWriter(const dictionary& options)
:
    surfaceWriter(),
    writeFormat_(wfLong),
    fieldMap_(),
...
void CML::nastranSurfaceWriter::write
(
...
) const
{
    ...
    os  << "TITLE=CAELUS " << surfaceName.c_str() << " mesh" << nl
        << "$" << nl
        << "BEGIN BULK" << nl;
