...
void CML::mapNearestMethod::calculateAddressing
(
...
void CML::mapNearestMethod::findNearestCell
(
...
void CML::mapNearestMethod::setNextNearestCells
(
    label& startSeedI,
    label& srcCellI,
    label& tgtCellI,
...
CML::mapNearestMethod::mapNearestMethod
(
    const polyMesh& src,
    const polyMesh& tgt
)
...
void CML::mapNearestMethod::calculate
(
