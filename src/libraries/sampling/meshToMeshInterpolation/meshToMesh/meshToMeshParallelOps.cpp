...
CML::label CML::meshToMesh::calcDistribution
(
    const polyMesh& src,
    const polyMesh& tgt
) const
...
CML::label CML::meshToMesh::calcOverlappingProcs
(
...
CML::autoPtr<CML::mapDistribute> CML::meshToMesh::calcProcMap
(
    const polyMesh& src,
    const polyMesh& tgt
) const
...
void CML::meshToMesh::distributeCells
(
...
void CML::meshToMesh::distributeAndMergeCells
(
    const mapDistribute& map,
    const polyMesh& tgt,
    const globalIndex& globalI,
