...
#include "extendedFeatureEdgeMesh.hpp"
...
CML::label CML::extendedFeatureEdgeMesh::convexStart_ = 0;


CML::label CML::extendedFeatureEdgeMesh::externalStart_ = 0;


CML::label CML::extendedFeatureEdgeMesh::nPointTypes = 4;


CML::label CML::extendedFeatureEdgeMesh::nEdgeTypes = 5;


// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

CML::extendedFeatureEdgeMesh::extendedFeatureEdgeMesh(const IOobject& io)
:
    regIOobject(io),
...
CML::extendedFeatureEdgeMesh::pointStatus
CML::extendedFeatureEdgeMesh::classifyFeaturePoint
(
    label ptI
) const
{
...
CML::extendedFeatureEdgeMesh::edgeStatus
CML::extendedFeatureEdgeMesh::classifyEdge
(
...
void CML::extendedFeatureEdgeMesh::nearestFeatureEdge
(
    const point& sample,
...
void CML::extendedFeatureEdgeMesh::nearestFeatureEdgeByType
(
    const point& sample,
    const scalarField& searchDistSqr,
    List<pointIndexHit>& info
...
CML::extendedFeatureEdgeMesh::edgeTree() const
{
    if (edgeTree_.empty())
    {
...
void CML::extendedFeatureEdgeMesh::writeObj
(
...
bool CML::extendedFeatureEdgeMesh::writeData(Ostream& os) const
{
