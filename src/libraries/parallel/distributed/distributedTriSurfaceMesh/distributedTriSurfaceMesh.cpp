...
#include "distributedTriSurfaceMesh.hpp"
...
namespace CML
{
    ...
    <
        CML::distributedTriSurfaceMesh::distributionType,
        3
    >::names[] =
    {
        "follow",
...
const CML::NamedEnum<CML::distributedTriSurfaceMesh::distributionType, 3>
    CML::distributedTriSurfaceMesh::distributionTypeNames_;


// * * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * //

// Read my additional data from the dictionary
bool CML::distributedTriSurfaceMesh::read()
{
...
bool CML::distributedTriSurfaceMesh::isLocal
(
...
//void CML::distributedTriSurfaceMesh::splitSegment
//(
...
void CML::distributedTriSurfaceMesh::distributeSegment
(
    const label segmentI,
    const point& start,
    const point& end,
...
CML::distributedTriSurfaceMesh::distributeSegments
(
...
void CML::distributedTriSurfaceMesh::findLine
(
...
CML::autoPtr<CML::mapDistribute>
CML::distributedTriSurfaceMesh::calcLocalQueries
(
...
CML::label CML::distributedTriSurfaceMesh::calcOverlappingProcs
(
    const point& centre,
...
)
{
    ...
    forAll(s, triI)
    {
        ...
        forAll(f, fp)
        {
            ...
            bbMin = ::CML::min(bbMin, pt);
            bbMax = ::CML::max(bbMax, pt);
        }
    }
...
bool CML::distributedTriSurfaceMesh::overlaps
(
...
void CML::distributedTriSurfaceMesh::subsetMeshMap
(
    const triSurface& s,
...
CML::triSurface CML::distributedTriSurfaceMesh::subsetMesh
(
    const triSurface& s,
...
CML::label CML::distributedTriSurfaceMesh::findTriangle
(
...
// Merge into allSurf.
void CML::distributedTriSurfaceMesh::merge
(
...
CML::distributedTriSurfaceMesh::distributedTriSurfaceMesh
(
    const IOobject& io,
    const triSurface& s,
...
CML::distributedTriSurfaceMesh::distributedTriSurfaceMesh(const IOobject& io)
:
    triSurfaceMesh
    (
        IOobject
...
void CML::distributedTriSurfaceMesh::clearOut()
{
    globalTris_.clear();
...
const CML::globalIndex& CML::distributedTriSurfaceMesh::globalTris() const
{
...
void CML::distributedTriSurfaceMesh::findNearest
(
...
void CML::distributedTriSurfaceMesh::findLineAny
(
    const pointField& start,
    const pointField& end,
    List<pointIndexHit>& info
...
void CML::distributedTriSurfaceMesh::findLineAll
(
    const pointField& start,
    const pointField& end,
...
void CML::distributedTriSurfaceMesh::getRegion
(
    const List<pointIndexHit>& info,
    labelList& region
) const
...
void CML::distributedTriSurfaceMesh::getNormal
(
    const List<pointIndexHit>& info,
    vectorField& normal
) const
...
void CML::distributedTriSurfaceMesh::getField
(
    const List<pointIndexHit>& info,
    labelList& values
) const
...
void CML::distributedTriSurfaceMesh::getVolumeType
(
...
CML::triSurface CML::distributedTriSurfaceMesh::overlappingSurface
(
    const triSurface& s,
    const List<treeBoundBox>& bbs,
...
void CML::distributedTriSurfaceMesh::distribute
(
    const List<treeBoundBox>& bbs,
...
bool CML::distributedTriSurfaceMesh::writeObject
(
...
void CML::distributedTriSurfaceMesh::writeStats(Ostream& os) const
{
    boundBox bb;
    label nPoints;
