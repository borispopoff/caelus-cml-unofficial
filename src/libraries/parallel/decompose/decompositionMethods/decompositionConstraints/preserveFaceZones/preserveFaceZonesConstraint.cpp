...
CML::decompositionConstraints::preserveFaceZonesConstraint::
preserveFaceZonesConstraint
(
...
void CML::decompositionConstraints::preserveFaceZonesConstraint::add
(
    const polyMesh& mesh,
...
void CML::decompositionConstraints::preserveFaceZonesConstraint::apply
(
    const polyMesh& mesh,
