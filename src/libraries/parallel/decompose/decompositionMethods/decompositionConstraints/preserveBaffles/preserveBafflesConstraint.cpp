...
CML::decompositionConstraints::preserveBafflesConstraint::
preserveBafflesConstraint
(
...
void CML::decompositionConstraints::preserveBafflesConstraint::add
(
    const polyMesh& mesh,
...
void CML::decompositionConstraints::preserveBafflesConstraint::apply
(
    const polyMesh& mesh,
