...
#include "hierarchGeomDecomp.hpp"
...
void CML::hierarchGeomDecomp::setDecompOrder()
{
...
CML::label CML::hierarchGeomDecomp::findLower
(
    const List<scalar>& l,
    const scalar t,
    const label initLow,
...
// avoids extra tests.
void CML::hierarchGeomDecomp::calculateSortedWeightedSizes
(
...
void CML::hierarchGeomDecomp::findBinary
(
    const label sizeTol,
...
void CML::hierarchGeomDecomp::sortComponent
(
    const label sizeTol,
...
CML::labelList CML::hierarchGeomDecomp::decompose
(
    const pointField& points
)
{
...
CML::hierarchGeomDecomp::hierarchGeomDecomp
(
