...
void CML::simpleGeomDecomp::assignToProcessorGroup
(
...
CML::labelList CML::simpleGeomDecomp::decomposeOneProc
(
...
CML::simpleGeomDecomp::simpleGeomDecomp(const dictionary& decompositionDict)
:
...
CML::labelList CML::simpleGeomDecomp::decompose
(
    const pointField& points
)
{
