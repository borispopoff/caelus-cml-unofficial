...
void CML::scotchDecomp::check(const int retVal, const char* str)
{
    if (retVal)
    {
...
CML::scotchDecomp::scotchDecomp(const dictionary& decompositionDict)
:
...
CML::labelList CML::scotchDecomp::decompose
(
    const polyMesh& mesh,
