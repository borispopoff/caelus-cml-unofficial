...
void CML::regionModels::regionModel1D::initialise()
{
    if (debug)
    {
...
bool CML::regionModels::regionModel1D::read()
{
    if (regionModel::read())
    {
...
bool CML::regionModels::regionModel1D::read(const dictionary& dict)
{
...
CML::tmp<CML::labelField> CML::regionModels::regionModel1D::moveMesh
(
...
CML::regionModels::regionModel1D::regionModel1D
(
    const fvMesh& mesh,
