...
#include "waxSolventEvaporation.hpp"
...
:
    ...
    activityCoeff_
    (
        DataEntry<scalar>::New("activityCoeff", coeffDict_)
    )
{}
...
)
{
    ...
    DimensionedField<scalar, volMesh> evapRateCoeff
    (
        IOobject
        (
    ...
    DimensionedField<scalar, volMesh> evapRateInf
    (
        IOobject
        (
    ...
    DimensionedField<scalar, volMesh> impingementRate
    (
        max
        (
           -film.rhoSp(),
