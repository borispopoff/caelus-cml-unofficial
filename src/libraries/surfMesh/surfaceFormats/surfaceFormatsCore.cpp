...
CML::word CML::fileFormats::surfaceFormatsCore::nativeExt("cas");

// * * * * * * * * * * * * * Static Member Functions * * * * * * * * * * * * //

CML::string CML::fileFormats::surfaceFormatsCore::getLineNoComment
(
    IFstream& is
)
{
...
#if 0
CML::fileName CML::fileFormats::surfaceFormatsCore::localMeshFileName
(
    const word& surfName
)
{
...
CML::fileName CML::fileFormats::surfaceFormatsCore::findMeshInstance
(
    const Time& t,
    const word& surfName
)
...
CML::fileName CML::fileFormats::surfaceFormatsCore::findMeshFile
(
    const Time& t,
    const word& surfName
)
...
bool CML::fileFormats::surfaceFormatsCore::checkSupport
(
...
CML::fileFormats::surfaceFormatsCore::surfaceFormatsCore()
{}
