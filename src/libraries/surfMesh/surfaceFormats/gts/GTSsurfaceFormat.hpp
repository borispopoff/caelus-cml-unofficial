...
Class
    CML::fileFormats::GTSsurfaceFormat
...
template<class Face>
CML::fileFormats::GTSsurfaceFormat<Face>::GTSsurfaceFormat
(
...
template<class Face>
bool CML::fileFormats::GTSsurfaceFormat<Face>::read
(
    const fileName& filename
)
{
...
template<class Face>
void CML::fileFormats::GTSsurfaceFormat<Face>::write
(
    const fileName& filename,
