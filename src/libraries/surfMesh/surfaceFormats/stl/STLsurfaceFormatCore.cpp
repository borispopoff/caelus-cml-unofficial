...
int CML::fileFormats::STLsurfaceFormatCore::detectBINARY
(
    const fileName& filename
)
{
    off_t dataFileSize = CML::fileSize(filename);
...
bool CML::fileFormats::STLsurfaceFormatCore::readBINARY
(
    istream& is,
...
void CML::fileFormats::STLsurfaceFormatCore::writeHeaderBINARY
(
    ostream& os,
    unsigned int nTris
)
