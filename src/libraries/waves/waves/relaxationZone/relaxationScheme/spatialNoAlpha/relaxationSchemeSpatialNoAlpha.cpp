...
#include "relaxationSchemeSpatialNoAlpha.hpp"
...
defineTypeNameAndDebug(relaxationSchemeSpatialNoAlpha, 0);
...
relaxationSchemeSpatialNoAlpha::relaxationSchemeSpatialNoAlpha
(
...
void relaxationSchemeSpatialNoAlpha::correct()
{
