...
:
    ...
    linearCoefficient_(dimensionedVector("null", dimless, Zero)),

    quadraticCoefficient_(dimensionedVector("null", dimless, Zero)),

    KCQuadraticCoefficient_(dimensionedVector("null", dimless, Zero)),
