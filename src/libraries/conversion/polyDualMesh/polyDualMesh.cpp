...
CML::labelList CML::polyDualMesh::getFaceOrder
(
...
// is in face order
void CML::polyDualMesh::getPointEdges
(
...
CML::labelList CML::polyDualMesh::collectPatchSideFace
(
...
void CML::polyDualMesh::collectPatchInternalFace
(
    const polyPatch& patch,
    const label patchToDualOffset,
    const labelList& edgeToDualPoint,
...
void CML::polyDualMesh::splitFace
(
    const polyPatch& patch,
    const labelList& pointToDualPoint,
...
void CML::polyDualMesh::dualPatch
(
    const polyPatch& patch,
    const label patchToDualOffset,
    const labelList& edgeToDualPoint,
...
void CML::polyDualMesh::calcDual
(
    const polyMesh& mesh,
...
CML::polyDualMesh::polyDualMesh(const IOobject& io)
:
    polyMesh(io),
    cellPoint_
    (
...
void CML::polyDualMesh::calcFeatures
(
    const polyMesh& mesh,
    const scalar featureCos,
