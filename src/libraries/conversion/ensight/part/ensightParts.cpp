...
#include "ensightParts.hpp"

// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

CML::ensightParts::ensightParts(const polyMesh& mesh)
:
    partsList_()
{
    recalculate(mesh);
...
CML::ensightParts::ensightParts(const IOobject& ioObj)
:
    partsList_()
{
...
CML::ensightParts::~ensightParts()
{}


// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //

void CML::ensightParts::recalculate(const polyMesh& mesh)
{
    partsList_.clear();
...
void CML::ensightParts::renumber
(
...
void CML::ensightParts::writeGeometry(ensightGeoFile& os) const
{
    // with some feedback
...
bool CML::ensightParts::writeSummary(Ostream& os) const
{
    forAll(partsList_, partI)
    {
...
void CML::ensightParts::writeData(Ostream& os) const
{
    // Begin write list
...
void CML::ensightParts::writeScalarField
(
    ensightFile& os,
...
void CML::ensightParts::writeVectorField
(
    ensightFile& os,
