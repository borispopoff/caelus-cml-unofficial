...
void CML::meshReader::addPolyBoundaryFace
(
    const label cellId,
...
void CML::meshReader::createPolyBoundary()
{
...
CML::List<CML::polyPatch*>
CML::meshReader::polyBoundaryPatches(const polyMesh& mesh)
{
