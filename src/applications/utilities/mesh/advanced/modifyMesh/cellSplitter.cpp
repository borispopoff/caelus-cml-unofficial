...
CML::cellSplitter::cellSplitter(const polyMesh& mesh)
:
    mesh_(mesh),
    addedPoints_()
{}
...
CML::cellSplitter::~cellSplitter()
{}


// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //

void CML::cellSplitter::setRefinement
(
...
void CML::cellSplitter::updateMesh(const mapPolyMesh& morphMap)
{
