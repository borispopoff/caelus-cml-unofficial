...
CML::fluentFvMesh::fluentFvMesh(const IOobject& io)
:
    fvMesh(io)
{}
...
void CML::fluentFvMesh::writeFluentMesh() const
{
    ...
    fluentMeshFile
        << "(0 \"CAELUS to Fluent Mesh File\")" << std::endl << std::endl
    ...
    forAll(boundary(), patchI)
    {
        ...
        forAll(patchFaces, facei)
        {
            ...
            // opposite from the CAELUS convention.
