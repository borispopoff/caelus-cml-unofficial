...
#include "edgeFaceCirculator.hpp"
...
// Dump state so far.
void CML::meshDualiser::dumpPolyTopoChange
(
...
void CML::meshDualiser::createFacesAroundEdge
(
...
void CML::meshDualiser::createFaceFromInternalFace
(
    const label facei,
    label& fp,
    polyTopoChange& meshMod
...
CML::meshDualiser::meshDualiser(const polyMesh& mesh)
:
    mesh_(mesh),
...
void CML::meshDualiser::setRefinement
(
    const bool splitFace,
