...
const CML::NamedEnum<CML::vector::components, 3>
    CML::channelIndex::vectorComponentsNames_;


// * * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * //

// Determines face blocking
void CML::channelIndex::walkOppositeFaces
(
    const polyMesh& mesh,
...
// Calculate regions.
void CML::channelIndex::calcLayeredRegions
(
    const polyMesh& mesh,
    const labelList& startFaces
)
