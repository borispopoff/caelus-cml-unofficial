...
bool CML::ensightMesh::faceToBeIncluded(const label facei) const
{
    bool res = false;
...
CML::cellShapeList CML::ensightMesh::map
(
...
void CML::ensightMesh::writePrims
(
    const cellShapeList& cellShapes,
...
void CML::ensightMesh::writePolysNFaces
(
...
void CML::ensightMesh::writePolysNPointsPerFace
(
    const labelList& polys,
    const cellList& cellFaces,
...
void CML::ensightMesh::writePolysPoints
(
    const labelList& polys,
    const cellList& cellFaces,
    const faceList& faces,
...
void CML::ensightMesh::writeAllPolys
(
    const labelList& pointToGlobal,
    ensightStream& ensightGeometryFile
) const
...
void CML::ensightMesh::writeAllPrims
(
    const char* key,
    const label nPrims,
    const cellShapeList& cellShapes,
...
void CML::ensightMesh::writeFacePrims
(
...
void CML::ensightMesh::writeAllFacePrims
(
    const char* key,
    const labelList& prims,
    const label nPrims,
...
void CML::ensightMesh::writeNSidedNPointsPerFace
(
    const faceList& patchFaces,
    ensightStream& ensightGeometryFile
) const
...
void CML::ensightMesh::writeNSidedPoints
(
    const faceList& patchFaces,
    ensightStream& ensightGeometryFile
) const
...
void CML::ensightMesh::writeAllNSided
(
    const labelList& prims,
    const label nPrims,
    const faceList& patchFaces,
...
) const
{
    ...
    if (Pstream::master())
    {
        string desc = string("written by CAELUS-") + CML::CAELUSversion;
