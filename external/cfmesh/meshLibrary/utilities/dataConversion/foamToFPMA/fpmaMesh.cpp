...
CML::fpmaMesh::fpmaMesh(const polyMeshGen& mesh)
:
    mesh_(mesh)
{
}
...
CML::fpmaMesh::~fpmaMesh()
{}

// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //

void CML::fpmaMesh::writePoints(CML::OFstream& fpmaGeometryFile) const
{
...
void CML::fpmaMesh::writeFaces(OFstream& fpmaGeometryFile) const
{
...
void CML::fpmaMesh::writeSubsets(CML::OFstream& fpmaGeometryFile) const
{
