...
int main(int argc, char *argv[])
{
    ...
    // Write faces and feature edges
    {
        ...
        tag.addAttribute("index", CML::name(index++));
    ...
    
    {
        ...
        xmlBlock.addAttribute("index", CML::name(index++));
        ...
        {            
            ...
            tag.addAttribute("index", CML::name(patchI));
    ...
    // Write point subsets
    {
        ...
        forAll(subsetIndices, id)
        {
            ...
            xmlTag& tag = xmlBlock.addChild("DataSet");
            tag.addAttribute("index", CML::name(id));
