...
try:
 ...
 scons_path = os.path.abspath(os.path.join(head,'../../external/scons-local-3.0.3/scons-local-3.0.3'))
...
from variables import caelus_vars
from environment import caelus_env

# imports from CPL
from caelus.config.cmlenv import cml_get_latest_version, cml_get_version
